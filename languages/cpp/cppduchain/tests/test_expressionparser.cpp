...
void TestExpressionParser::testSmartPointer() {
  ...
  qDebug() << typeid(baseTemplateContext).name();
  qDebug() << typeid(specialTemplateContext).name();
  ...
  qDebug() << top->localDeclarations()[3]->abstractType()->toString();
...
void TestExpressionParser::testSimpleExpression() {
  ...
  qDebug() << "test-Context:" << testContext;
  lock.unlock();
  ...
  QCOMPARE(result.type.type<ConstantIntegralType>()->value<int>(), 5);
  QCOMPARE(result.type.abstractType()->toString(), QString("int"));
  QVERIFY(result.isInstance);
  lock.unlock();
  ...
  QVERIFY(result.isValid());
  QVERIFY(result.type.type<ConstantIntegralType>());
  QCOMPARE(result.type.type<ConstantIntegralType>()->value<double>(), 5.5);
  QCOMPARE(result.type.abstractType()->toString(), QString("double"));
  QVERIFY(result.isInstance);
  lock.unlock();
  QVERIFY(!TypeUtils::isNullType(result.type.abstractType()));
  ...
  QVERIFY(result.isValid());
  QVERIFY(result.type.type<ConstantIntegralType>());
  QCOMPARE(result.type.type<ConstantIntegralType>()->value<double>(), 7.);
  QCOMPARE(result.type.abstractType()->toString(), QString("double"));
  QVERIFY(result.isInstance);
  lock.unlock();
  QVERIFY(!TypeUtils::isNullType(result.type.abstractType()));
  ...
  QVERIFY(result.isValid());
  QVERIFY(result.type.type<ConstantIntegralType>());
  QCOMPARE(result.type.type<ConstantIntegralType>()->value<double>(), 3.5);
  QCOMPARE(result.type.abstractType()->toString(), QString("double"));
  QVERIFY(result.isInstance);
  lock.unlock();
  QVERIFY(!TypeUtils::isNullType(result.type.abstractType()));
  ...
  QVERIFY(result.isValid());
  QVERIFY(result.type.type<ConstantIntegralType>());
  QCOMPARE(result.type.type<ConstantIntegralType>()->value<int>(), 0);
  QCOMPARE(result.type.abstractType()->toString(), QString("int"));
  QVERIFY(result.isInstance);
  lock.unlock();
  QVERIFY(TypeUtils::isNullType(result.type.abstractType()));
...
void TestExpressionParser::testEnum() {
  ...
  qDebug() << typeid(*result.type.abstractType()).name();
...
void TestExpressionParser::testTemplateFunctions() {
  ...
  /*  IdentifiedType* identified = dynamic_cast<IdentifiedType*>(result.type.abstractType().data());
    Q_ASSERT(identified);*/
    //qDebug() << "identified:" << identified->qualifiedIdentifier();
    QCOMPARE(result.type.abstractType()->indexed(), top->localDeclarations()[1]->abstractType()->indexed());
...
//     QVERIFY(result.isValid());
//     QCOMPARE(result.type.abstractType()->indexed(), top->localDeclarations()[0]->abstractType()->indexed());
//     qDebug() << result.type.abstractType()->toString();
