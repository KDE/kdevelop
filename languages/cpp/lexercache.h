...
class KDEVCPPPARSER_EXPORT CachedLexedFile : public CacheNode, public KDevelop::ParsingEnvironmentFile {
  public:
    ...
    CachedLexedFile( const KUrl& url, EnvironmentManager* manager );
...
class KDEVCPPPARSER_EXPORT EnvironmentManager : public CacheManager, public KDevelop::ParsingEnvironmentManager {
  public:
    EnvironmentManager();
    ...
    virtual void addFile( KDevelop::ParsingEnvironmentFilePointer file );
    ///Remove a file from the manager
    virtual void removeFile( KDevelop::ParsingEnvironmentFilePointer file );

    /**
     * Search for the availability of a file parsed in a given environment 
     * */
    virtual KDevelop::IdentifiedFile find( const KUrl& url, const KDevelop::ParsingEnvironment* environment );
  ...
  private:
    ...
    CachedLexedFilePointer lexedFile( const HashedString& fileName, const rpp::Environment* environment );
    CachedLexedFilePointer lexedFile( const KUrl& url, const rpp::Environment* environment );

    void addLexedFile( const CachedLexedFilePointer& file );
    void removeLexedFile( const CachedLexedFilePointer& file );
