...
void AdaParser::compilation_unit() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST compilation_unit_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::context_items_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST context_items_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 86 "ada.g"
			context_items_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(CONTEXT_CLAUSE,"CONTEXT_CLAUSE")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(context_items_opt_AST))));
#line 169 "AdaParser.cpp"
			currentAST.root = context_items_opt_AST;
			if ( context_items_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				context_items_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::library_item() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST library_item_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 133 "ada.g"
			library_item_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(LIBRARY_ITEM,"LIBRARY_ITEM")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(library_item_AST))));
#line 239 "AdaParser.cpp"
			currentAST.root = library_item_AST;
			if ( library_item_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				library_item_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::subunit() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST subunit_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  sep = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST sep_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		sep = LT(1);
		if ( inputState->guessing == 0 ) {
			sep_AST = astFactory->create(sep);
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(sep_AST));
		}
		match(SEPARATE);
		match(LPAREN);
		compound_name();
...
void AdaParser::pragma() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST pragma_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		RefAdaAST tmp3_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
			tmp3_AST = astFactory->create(LT(1));
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp3_AST));
		}
		match(PRAGMA);
		RefAdaAST tmp4_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
			tmp4_AST = astFactory->create(LT(1));
			astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp4_AST));
		}
		match(IDENTIFIER);
		pragma_args_opt();
		if (inputState->guessing==0) {
...
void AdaParser::pragma_args_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST pragma_args_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::pragma_arg() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST pragma_arg_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		{
		if ((LA(1) == IDENTIFIER) && (LA(2) == RIGHT_SHAFT)) {
			RefAdaAST tmp9_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp9_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp9_AST));
			}
			match(IDENTIFIER);
			RefAdaAST tmp10_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp10_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp10_AST));
			}
			match(RIGHT_SHAFT);
		}
...
void AdaParser::expression() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST expression_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  a = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST a_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  o = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST o_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		...
		for (;;) {
			...
			case AND:
			{
				...
				if ( inputState->guessing == 0 ) {
					...
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(a_AST));
				}
				match(AND);
				{
				switch ( LA(1)) {
...
#line 516 "AdaParser.cpp"
			...
			case OR:
			{
				...
				if ( inputState->guessing == 0 ) {
					...
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(o_AST));
				}
				match(OR);
				{
				switch ( LA(1)) {
...
#line 562 "AdaParser.cpp"
			...
			case XOR:
			{
				RefAdaAST tmp13_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp13_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp13_AST));
				}
				match(XOR);
				relation();
				if (inputState->guessing==0) {
...
void AdaParser::with_clause() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST with_clause_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  w = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST w_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		w = LT(1);
		if ( inputState->guessing == 0 ) {
			w_AST = astFactory->create(w);
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(w_AST));
		}
		match(WITH);
		c_name_list();
		if (inputState->guessing==0) {
...
void AdaParser::use_clause() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST use_clause_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  u = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST u_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		u = LT(1);
		if ( inputState->guessing == 0 ) {
			u_AST = astFactory->create(u);
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(u_AST));
		}
		match(USE);
		{
		switch ( LA(1)) {
...
void AdaParser::c_name_list() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST c_name_list_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::compound_name() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST compound_name_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		RefAdaAST tmp19_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
			tmp19_AST = astFactory->create(LT(1));
			astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp19_AST));
		}
		match(IDENTIFIER);
		{ // ( ... )*
		for (;;) {
			if ((LA(1) == DOT)) {
				RefAdaAST tmp20_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp20_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp20_AST));
				}
				match(DOT);
				RefAdaAST tmp21_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
...
void AdaParser::subtype_mark() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST subtype_mark_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case TIC:
		{
			RefAdaAST tmp22_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
...
void AdaParser::attribute_id() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST attribute_id_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		switch ( LA(1)) {
		case RANGE:
		{
			RefAdaAST tmp23_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
		...
		case DIGITS:
		{
			RefAdaAST tmp24_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
		...
		case DELTA:
		{
			RefAdaAST tmp25_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
		...
		case ACCESS:
		{
			RefAdaAST tmp26_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
		...
		case IDENTIFIER:
		{
			RefAdaAST tmp27_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
...
void AdaParser::private_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST private_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case PRIVATE:
		{
			RefAdaAST tmp28_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
...
#line 137 "ada.g"
			private_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(private_opt_AST))));
#line 1020 "AdaParser.cpp"
			currentAST.root = private_opt_AST;
			if ( private_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				private_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::lib_pkg_spec_or_body() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST lib_pkg_spec_or_body_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  pkg = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST pkg_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		pkg = LT(1);
		if ( inputState->guessing == 0 ) {
			pkg_AST = astFactory->create(pkg);
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(pkg_AST));
		}
		match(PACKAGE);
		{
		switch ( LA(1)) {
...
void AdaParser::subprog_decl_or_rename_or_inst_or_body(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST subprog_decl_or_rename_or_inst_or_body_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  f = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST f_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
#line 930 "ada.g"
	RefAdaAST t;
...
#line 1225 "AdaParser.cpp"
		...
		case FUNCTION:
		{
			...
			if ( inputState->guessing == 0 ) {
				...
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(f_AST));
			}
			match(FUNCTION);
...
void AdaParser::generic_decl(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST generic_decl_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  g = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST g_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		g = LT(1);
		if ( inputState->guessing == 0 ) {
			g_AST = astFactory->create(g);
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(g_AST));
		}
		match(GENERIC);
...
void AdaParser::def_id(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST def_id_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	RefAdaAST cn_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  n = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST n_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1580 "AdaParser.cpp"
			...
			if ( inputState->guessing == 0 ) {
				...
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(n_AST));
			}
			match(IDENTIFIER);
			if ( inputState->guessing==0 ) {
#line 172 "ada.g"
...
void AdaParser::pkg_body_part() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST pkg_body_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::end_id_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST end_id_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::spec_decl_part(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST spec_decl_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::subprog_decl(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST subprog_decl_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  f = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST f_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::generic_subp_inst() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST generic_subp_inst_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::formal_part_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST formal_part_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 234 "ada.g"
			formal_part_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(FORMAL_PART_OPT,"FORMAL_PART_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(formal_part_opt_AST))));
#line 2021 "AdaParser.cpp"
			currentAST.root = formal_part_opt_AST;
			if ( formal_part_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				formal_part_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::renames() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST renames_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
#line 257 "ada.g"
	RefAdaAST dummy;
...
void AdaParser::is_separate_or_abstract_or_decl(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST is_separate_or_abstract_or_decl_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::def_designator(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST def_designator_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	RefAdaAST n_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
#line 329 "ada.g"
	RefAdaAST d;
...
void AdaParser::function_tail() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST function_tail_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::generic_inst() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST generic_inst_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::value_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST value_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1380 "ada.g"
			value_s_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(VALUES,"VALUES")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(value_s_AST))));
#line 2309 "AdaParser.cpp"
			currentAST.root = value_s_AST;
			if ( value_s_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				value_s_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::parenth_values() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST parenth_values_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::value() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST value_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case OTHERS:
		{
			RefAdaAST tmp61_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
		...
		case NUMERIC_LIT:
		{
			...
			case RIGHT_SHAFT:
			{
				RefAdaAST tmp63_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
...
void AdaParser::ranged_expr_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST ranged_expr_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		for (;;) {
			if ((LA(1) == PIPE)) {
				RefAdaAST tmp64_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp64_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp64_AST));
				}
				match(PIPE);
				ranged_expr();
				if (inputState->guessing==0) {
...
void AdaParser::ranged_expr() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST ranged_expr_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case DOT_DOT:
		{
			RefAdaAST tmp65_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
		...
		case RANGE:
		{
			RefAdaAST tmp66_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp66_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp66_AST));
			}
			match(RANGE);
			range();
			if (inputState->guessing==0) {
...
void AdaParser::simple_expression() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST simple_expression_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		for (;;) {
			...
			case PLUS:
			{
				RefAdaAST tmp67_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
			...
			case MINUS:
			{
				RefAdaAST tmp68_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
			...
			case CONCAT:
			{
				RefAdaAST tmp69_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
...
void AdaParser::range() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST range_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::range_constraint() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST range_constraint_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::range_dots() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST range_dots_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		RefAdaAST tmp71_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
			tmp71_AST = astFactory->create(LT(1));
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp71_AST));
		}
		match(DOT_DOT);
		simple_expression();
		if (inputState->guessing==0) {
...
void AdaParser::range_attrib_ref() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST range_attrib_ref_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  r = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST r_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		if ( inputState->guessing == 0 ) {
			...
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(r_AST));
		}
		match(RANGE);
		{
		switch ( LA(1)) {
...
void AdaParser::prefix() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST prefix_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		RefAdaAST tmp75_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
			tmp75_AST = astFactory->create(LT(1));
			astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp75_AST));
		}
		match(IDENTIFIER);
		{ // ( ... )*
		for (;;) {
			...
			case DOT:
			{
				RefAdaAST tmp76_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
				...
				case ALL:
				{
					RefAdaAST tmp77_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
					if ( inputState->guessing == 0 ) {
						tmp77_AST = astFactory->create(LT(1));
						astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp77_AST));
					}
					match(ALL);
					break;
				}
				case IDENTIFIER:
				{
					RefAdaAST tmp78_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
					if ( inputState->guessing == 0 ) {
						tmp78_AST = astFactory->create(LT(1));
						astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp78_AST));
					}
					match(IDENTIFIER);
					break;
				}
...
void AdaParser::parameter_specification() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST parameter_specification_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 239 "ada.g"
			parameter_specification_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(PARAMETER_SPECIFICATION,"PARAMETER_SPECIFICATION")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(parameter_specification_AST))));
#line 2965 "AdaParser.cpp"
			currentAST.root = parameter_specification_AST;
			if ( parameter_specification_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				parameter_specification_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::def_ids_colon() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST def_ids_colon_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::mode_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST mode_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case IN:
		{
			RefAdaAST tmp81_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp81_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp81_AST));
			}
			match(IN);
			{
			switch ( LA(1)) {
			case OUT:
			{
				RefAdaAST tmp82_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp82_AST = astFactory->create(LT(1));
					astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp82_AST));
				}
				match(OUT);
				break;
			}
		...
		case OUT:
		{
			RefAdaAST tmp83_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp83_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp83_AST));
			}
			match(OUT);
			break;
		}
		case ACCESS:
		{
			RefAdaAST tmp84_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp84_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp84_AST));
			}
			match(ACCESS);
			break;
		}
...
#line 254 "ada.g"
			mode_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(mode_opt_AST))));
#line 3087 "AdaParser.cpp"
			currentAST.root = mode_opt_AST;
			if ( mode_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				mode_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::init_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST init_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 460 "ada.g"
			init_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(INIT_OPT,"INIT_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(init_opt_AST))));
#line 3142 "AdaParser.cpp"
			currentAST.root = init_opt_AST;
			if ( init_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				init_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::defining_identifier_list() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST defining_identifier_list_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		RefAdaAST tmp86_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
		...
		for (;;) {
			if ((LA(1) == COMMA)) {
				match(COMMA);
				RefAdaAST tmp88_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp88_AST = astFactory->create(LT(1));
					astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp88_AST));
				}
				match(IDENTIFIER);
			}
			else {
...
#line 248 "ada.g"
			defining_identifier_list_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DEFINING_IDENTIFIER_LIST,"DEFINING_IDENTIFIER_LIST")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(defining_identifier_list_AST))));
#line 3200 "AdaParser.cpp"
			currentAST.root = defining_identifier_list_AST;
			if ( defining_identifier_list_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				defining_identifier_list_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::name() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST name_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
#line 264 "ada.g"
	RefAdaAST dummy;
#line 3231 "AdaParser.cpp"
	...
	try {      // for error handling
		RefAdaAST tmp89_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
		...
		for (;;) {
			...
			case DOT:
			{
				RefAdaAST tmp90_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
				...
				case ALL:
				{
					RefAdaAST tmp91_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
					if ( inputState->guessing == 0 ) {
				...
				case IDENTIFIER:
				{
					RefAdaAST tmp92_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
					if ( inputState->guessing == 0 ) {
				...
				case CHARACTER_LITERAL:
				{
					RefAdaAST tmp93_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
					if ( inputState->guessing == 0 ) {
						tmp93_AST = astFactory->create(LT(1));
						astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp93_AST));
					}
...
#line 3315 "AdaParser.cpp"
			...
			case TIC:
			{
				RefAdaAST tmp95_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
...
#line 3358 "AdaParser.cpp"
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST definable_operator_symbol_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  op = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST op_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		if ( inputState->guessing == 0 ) {
			...
			astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(op_AST));
		}
		match(CHAR_STRING);
		if ( inputState->guessing==0 ) {
#line 286 "ada.g"
...
#line 3397 "AdaParser.cpp"
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST is_operator_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  op = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST op_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::parenthesized_primary() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST parenthesized_primary_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  pp = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST pp_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		pp = LT(1);
		if ( inputState->guessing == 0 ) {
			pp_AST = astFactory->create(pp);
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(pp_AST));
		}
		match(LPAREN);
		{
		if ((LA(1) == NuLL) && (LA(2) == RECORD)) {
			RefAdaAST tmp96_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp96_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp96_AST));
			}
			match(NuLL);
			match(RECORD);
		}
...
void AdaParser::extension_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST extension_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case WITH:
		{
			...
			{
			if ((LA(1) == NuLL) && (LA(2) == RECORD)) {
				RefAdaAST tmp100_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
...
#line 298 "ada.g"
			extension_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(EXTENSION_OPT,"EXTENSION_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(extension_opt_AST))));
#line 3541 "AdaParser.cpp"
			currentAST.root = extension_opt_AST;
			if ( extension_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				extension_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::separate_or_abstract(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST separate_or_abstract_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 3624 "AdaParser.cpp"
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST designator_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  n = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST n_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
#line 335 "ada.g"
	RefAdaAST op;
...
void AdaParser::func_formal_part_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST func_formal_part_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 347 "ada.g"
			func_formal_part_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(FORMAL_PART_OPT,"FORMAL_PART_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(func_formal_part_opt_AST))));
#line 3734 "AdaParser.cpp"
			currentAST.root = func_formal_part_opt_AST;
			if ( func_formal_part_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				func_formal_part_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::func_param() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST func_param_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 353 "ada.g"
			func_param_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(PARAMETER_SPECIFICATION,"PARAMETER_SPECIFICATION")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(func_param_AST))));
#line 3784 "AdaParser.cpp"
			currentAST.root = func_param_AST;
			if ( func_param_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				func_param_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::in_access_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST in_access_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case ACCESS:
		{
			RefAdaAST tmp108_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
...
#line 359 "ada.g"
			in_access_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(in_access_opt_AST))));
#line 3844 "AdaParser.cpp"
			currentAST.root = in_access_opt_AST;
			if ( in_access_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				in_access_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::pkg_spec_part() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST pkg_spec_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::basic_declarative_items_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST basic_declarative_items_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 377 "ada.g"
			basic_declarative_items_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(BASIC_DECLARATIVE_ITEMS_OPT,"BASIC_DECLARATIVE_ITEMS_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(basic_declarative_items_opt_AST))));
#line 3961 "AdaParser.cpp"
			currentAST.root = basic_declarative_items_opt_AST;
			if ( basic_declarative_items_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				basic_declarative_items_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::basic_decl_item() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST basic_decl_item_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  pkg = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST pkg_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  tsk = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST tsk_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  pro = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST pro_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case TASK:
		{
			...
			if ( inputState->guessing == 0 ) {
				...
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tsk_AST));
			}
			match(TASK);
		...
		case PROTECTED:
		{
			...
			if ( inputState->guessing == 0 ) {
				...
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(pro_AST));
			}
			match(PROTECTED);
...
void AdaParser::basic_declarative_items() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST basic_declarative_items_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 384 "ada.g"
			basic_declarative_items_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(BASIC_DECLARATIVE_ITEMS_OPT,"BASIC_DECLARATIVE_ITEMS_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(basic_declarative_items_AST))));
#line 4139 "AdaParser.cpp"
			currentAST.root = basic_declarative_items_AST;
			if ( basic_declarative_items_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				basic_declarative_items_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::task_type_or_single_decl(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST task_type_or_single_decl_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::prot_type_or_single_decl(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST prot_type_or_single_decl_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::decl_common() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST decl_common_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  t = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST t_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  s = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  r = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST r_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  erd = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST erd_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  ord = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST ord_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  od = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST od_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case TYPE:
		{
			...
			if ( inputState->guessing == 0 ) {
				...
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(t_AST));
			}
			match(TYPE);
			RefAdaAST tmp113_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp113_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp113_AST));
			}
			match(IDENTIFIER);
			{
			switch ( LA(1)) {
...
#line 4390 "AdaParser.cpp"
		...
		case SUBTYPE:
		{
			...
			if ( inputState->guessing == 0 ) {
				...
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(s_AST));
			}
			match(SUBTYPE);
			RefAdaAST tmp117_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp117_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp117_AST));
			}
			match(IDENTIFIER);
			match(IS);
			subtype_ind();
...
#line 4498 "AdaParser.cpp"
		...
		default:
			...
			if ( synPredMatched184 ) {
				RefAdaAST tmp123_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp123_AST = astFactory->create(LT(1));
					astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp123_AST));
				}
				match(IDENTIFIER);
				erd = LT(1);
				if ( inputState->guessing == 0 ) {
					erd_AST = astFactory->create(erd);
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(erd_AST));
				}
				match(COLON);
				match(EXCEPTION);
				match(RENAMES);
...
#line 4564 "AdaParser.cpp"
				...
				if ( synPredMatched186 ) {
					RefAdaAST tmp127_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
					if ( inputState->guessing == 0 ) {
						tmp127_AST = astFactory->create(LT(1));
						astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp127_AST));
					}
					match(IDENTIFIER);
					ord = LT(1);
					if ( inputState->guessing == 0 ) {
						ord_AST = astFactory->create(ord);
						astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(ord_AST));
					}
					match(COLON);
					subtype_mark();
					if (inputState->guessing==0) {
...
#line 4614 "AdaParser.cpp"
					...
					if ( inputState->guessing == 0 ) {
						...
						astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(od_AST));
					}
					match(COLON);
					{
					if ((LA(1) == EXCEPTION)) {
...
void AdaParser::discrim_part_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discrim_part_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 412 "ada.g"
			discrim_part_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DISCRIM_PART_OPT,"DISCRIM_PART_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(discrim_part_opt_AST))));
#line 4774 "AdaParser.cpp"
			currentAST.root = discrim_part_opt_AST;
			if ( discrim_part_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				discrim_part_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::task_definition_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST task_definition_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::task_items_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST task_items_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 465 "ada.g"
			task_items_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(TASK_ITEMS_OPT,"TASK_ITEMS_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(task_items_opt_AST))));
#line 4879 "AdaParser.cpp"
			currentAST.root = task_items_opt_AST;
			if ( task_items_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				task_items_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::private_task_items_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST private_task_items_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 522 "ada.g"
			private_task_items_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(PRIVATE_TASK_ITEMS_OPT,"PRIVATE_TASK_ITEMS_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(private_task_items_opt_AST))));
#line 4949 "AdaParser.cpp"
			currentAST.root = private_task_items_opt_AST;
			if ( private_task_items_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				private_task_items_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::discrim_part_text() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discrim_part_text_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case BOX:
		{
			RefAdaAST tmp139_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
...
void AdaParser::discriminant_specifications() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discriminant_specifications_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 442 "ada.g"
			discriminant_specifications_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DISCRIMINANT_SPECIFICATIONS,"DISCRIMINANT_SPECIFICATIONS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(discriminant_specifications_AST))));
#line 5051 "AdaParser.cpp"
			currentAST.root = discriminant_specifications_AST;
			if ( discriminant_specifications_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				discriminant_specifications_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::known_discrim_part() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST known_discrim_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 422 "ada.g"
			known_discrim_part_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DISCRIM_PART_OPT,"DISCRIM_PART_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(known_discrim_part_AST))));
#line 5091 "AdaParser.cpp"
			currentAST.root = known_discrim_part_AST;
			if ( known_discrim_part_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				known_discrim_part_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::empty_discrim_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST empty_discrim_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 428 "ada.g"
			empty_discrim_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DISCRIM_PART_OPT,"DISCRIM_PART_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(empty_discrim_opt_AST))));
#line 5125 "AdaParser.cpp"
			currentAST.root = empty_discrim_opt_AST;
			if ( empty_discrim_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				empty_discrim_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::discrim_part() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discrim_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 435 "ada.g"
			discrim_part_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DISCRIM_PART_OPT,"DISCRIM_PART_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(discrim_part_AST))));
#line 5163 "AdaParser.cpp"
			currentAST.root = discrim_part_AST;
			if ( discrim_part_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				discrim_part_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::discriminant_specification() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discriminant_specification_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 449 "ada.g"
			discriminant_specification_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DISCRIMINANT_SPECIFICATION,"DISCRIMINANT_SPECIFICATION")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(discriminant_specification_AST))));
#line 5213 "AdaParser.cpp"
			currentAST.root = discriminant_specification_AST;
			if ( discriminant_specification_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				discriminant_specification_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::access_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST access_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case ACCESS:
		{
			RefAdaAST tmp144_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp144_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp144_AST));
			}
			match(ACCESS);
			break;
		}
...
#line 456 "ada.g"
			access_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(access_opt_AST))));
#line 5268 "AdaParser.cpp"
			currentAST.root = access_opt_AST;
			if ( access_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				access_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::entrydecls_repspecs_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST entrydecls_repspecs_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::entry_declaration() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST entry_declaration_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  e = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST e_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		match(ENTRY);
		RefAdaAST tmp145_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
			tmp145_AST = astFactory->create(LT(1));
			astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp145_AST));
		}
		match(IDENTIFIER);
...
void AdaParser::rep_spec() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST rep_spec_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  r = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST r_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::discrete_subtype_def_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discrete_subtype_def_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 481 "ada.g"
			discrete_subtype_def_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DISCRETE_SUBTYPE_DEF_OPT,"DISCRETE_SUBTYPE_DEF_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(discrete_subtype_def_opt_AST))));
#line 5484 "AdaParser.cpp"
			currentAST.root = discrete_subtype_def_opt_AST;
			if ( discrete_subtype_def_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				discrete_subtype_def_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::discrete_subtype_definition() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discrete_subtype_definition_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::subtype_ind() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST subtype_ind_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 679 "ada.g"
			subtype_ind_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(SUBTYPE_INDICATION,"SUBTYPE_INDICATION")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(subtype_ind_AST))));
#line 5579 "AdaParser.cpp"
			currentAST.root = subtype_ind_AST;
			if ( subtype_ind_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				subtype_ind_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::rep_spec_part(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST rep_spec_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::align_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST align_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 513 "ada.g"
			align_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MOD_CLAUSE_OPT,"MOD_CLAUSE_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(align_opt_AST))));
#line 5724 "AdaParser.cpp"
			currentAST.root = align_opt_AST;
			if ( align_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				align_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::comp_loc_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST comp_loc_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 517 "ada.g"
			comp_loc_s_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(COMPONENT_CLAUSES_OPT,"COMPONENT_CLAUSES_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(comp_loc_s_AST))));
#line 5795 "AdaParser.cpp"
			currentAST.root = comp_loc_s_AST;
			if ( comp_loc_s_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				comp_loc_s_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::protected_definition() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST protected_definition_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::prot_op_decl_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST prot_op_decl_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 541 "ada.g"
			prot_op_decl_s_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(PROT_OP_DECLARATIONS,"PROT_OP_DECLARATIONS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(prot_op_decl_s_AST))));
#line 5890 "AdaParser.cpp"
			currentAST.root = prot_op_decl_s_AST;
			if ( prot_op_decl_s_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				prot_op_decl_s_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::prot_member_decl_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST prot_member_decl_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 555 "ada.g"
			prot_member_decl_s_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(PROT_MEMBER_DECLARATIONS,"PROT_MEMBER_DECLARATIONS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(prot_member_decl_s_AST))));
#line 5955 "AdaParser.cpp"
			currentAST.root = prot_member_decl_s_AST;
			if ( prot_member_decl_s_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				prot_member_decl_s_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::prot_op_decl() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST prot_op_decl_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  f = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST f_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::comp_decl() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST comp_decl_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 561 "ada.g"
			comp_decl_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(COMPONENT_DECLARATION,"COMPONENT_DECLARATION")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(comp_decl_AST))));
#line 6108 "AdaParser.cpp"
			currentAST.root = comp_decl_AST;
			if ( comp_decl_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				comp_decl_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::component_subtype_def() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST component_subtype_def_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::type_def(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST type_def_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::derived_or_private_or_record(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST derived_or_private_or_record_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::local_enum_name() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST local_enum_name_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		RefAdaAST tmp179_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
...
void AdaParser::enumeration_aggregate() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST enumeration_aggregate_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::aliased_constant_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST aliased_constant_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case ALIASED:
		{
			RefAdaAST tmp180_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
		...
		case CONSTANT:
		{
			RefAdaAST tmp181_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp181_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp181_AST));
			}
			match(CONSTANT);
			break;
		}
...
#line 844 "ada.g"
			aliased_constant_opt_AST =
				  RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(aliased_constant_opt_AST))));
#line 6603 "AdaParser.cpp"
			currentAST.root = aliased_constant_opt_AST;
			if ( aliased_constant_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				aliased_constant_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::array_type_definition(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST array_type_definition_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::enum_id_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST enum_id_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::range_constraint_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST range_constraint_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::access_type_definition(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST access_type_definition_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::enumeration_literal_specification() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST enumeration_literal_specification_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		switch ( LA(1)) {
		case IDENTIFIER:
		{
			RefAdaAST tmp191_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
		...
		case CHARACTER_LITERAL:
		{
			RefAdaAST tmp192_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp192_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp192_AST));
			}
			match(CHARACTER_LITERAL);
			enumeration_literal_specification_AST = static_cast<RefAdaAST>(currentAST.root);
			break;
...
void AdaParser::index_or_discrete_range_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST index_or_discrete_range_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		for (;;) {
			if ((LA(1) == COMMA)) {
				RefAdaAST tmp193_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp193_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp193_AST));
				}
				match(COMMA);
				index_or_discrete_range();
				if (inputState->guessing==0) {
...
void AdaParser::index_or_discrete_range() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST index_or_discrete_range_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case DOT_DOT:
		{
			RefAdaAST tmp194_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp194_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp194_AST));
			}
			match(DOT_DOT);
			simple_expression();
			if (inputState->guessing==0) {
		...
		case RANGE:
		{
			RefAdaAST tmp195_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp195_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp195_AST));
			}
			match(RANGE);
			{
			switch ( LA(1)) {
			case BOX:
			{
				RefAdaAST tmp196_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
...
void AdaParser::aliased_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST aliased_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case ALIASED:
		{
			RefAdaAST tmp197_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
...
#line 675 "ada.g"
			aliased_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(aliased_opt_AST))));
#line 7072 "AdaParser.cpp"
			currentAST.root = aliased_opt_AST;
			if ( aliased_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				aliased_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::constraint_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST constraint_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::digits_constraint() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST digits_constraint_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  d = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST d_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		d = LT(1);
		if ( inputState->guessing == 0 ) {
			d_AST = astFactory->create(d);
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(d_AST));
		}
		match(DIGITS);
		expression();
		if (inputState->guessing==0) {
...
void AdaParser::delta_constraint() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST delta_constraint_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  d = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST d_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::index_constraint() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST index_constraint_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::discriminant_constraint() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discriminant_constraint_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::discrete_range() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discrete_range_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::discriminant_association() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discriminant_association_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 714 "ada.g"
			discriminant_association_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DISCRIMINANT_ASSOCIATION,"DISCRIMINANT_ASSOCIATION")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(discriminant_association_AST))));
#line 7446 "AdaParser.cpp"
			currentAST.root = discriminant_association_AST;
			if ( discriminant_association_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				discriminant_association_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::selector_names_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST selector_names_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 722 "ada.g"
			selector_names_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(SELECTOR_NAMES_OPT,"SELECTOR_NAMES_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(selector_names_opt_AST))));
#line 7510 "AdaParser.cpp"
			currentAST.root = selector_names_opt_AST;
			if ( selector_names_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				selector_names_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::association_head() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST association_head_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::selector_name() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST selector_name_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		RefAdaAST tmp204_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
...
void AdaParser::protected_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST protected_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case PROTECTED:
		{
			RefAdaAST tmp205_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp205_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp205_AST));
			}
			match(PROTECTED);
			break;
		}
...
#line 747 "ada.g"
			protected_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(protected_opt_AST))));
#line 7633 "AdaParser.cpp"
			currentAST.root = protected_opt_AST;
			if ( protected_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				protected_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::constant_all_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST constant_all_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case CONSTANT:
		{
			RefAdaAST tmp206_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp206_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp206_AST));
			}
			match(CONSTANT);
			break;
		}
		case ALL:
		{
			RefAdaAST tmp207_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp207_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp207_AST));
			}
			match(ALL);
			break;
		}
...
#line 751 "ada.g"
			constant_all_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(constant_all_opt_AST))));
#line 7699 "AdaParser.cpp"
			currentAST.root = constant_all_opt_AST;
			if ( constant_all_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				constant_all_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::abstract_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST abstract_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case ABSTRACT:
		{
			RefAdaAST tmp208_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp208_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp208_AST));
			}
			match(ABSTRACT);
			break;
		}
...
#line 771 "ada.g"
			abstract_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(abstract_opt_AST))));
#line 7754 "AdaParser.cpp"
			currentAST.root = abstract_opt_AST;
			if ( abstract_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				abstract_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::record_definition(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST record_definition_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::abstract_tagged_limited_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST abstract_tagged_limited_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case ABSTRACT:
		{
			RefAdaAST tmp214_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp214_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp214_AST));
			}
			match(ABSTRACT);
			match(TAGGED);
			break;
		...
		case TAGGED:
		{
			RefAdaAST tmp216_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp216_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp216_AST));
			}
			match(TAGGED);
			break;
		}
		...
		case LIMITED:
		{
			RefAdaAST tmp217_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp217_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp217_AST));
			}
			match(LIMITED);
			break;
		}
...
#line 833 "ada.g"
			abstract_tagged_limited_opt_AST =
				  RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(abstract_tagged_limited_opt_AST))));
#line 7894 "AdaParser.cpp"
			currentAST.root = abstract_tagged_limited_opt_AST;
			if ( abstract_tagged_limited_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				abstract_tagged_limited_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::component_list(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST component_list_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::component_items() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST component_items_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 786 "ada.g"
			component_items_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(COMPONENT_ITEMS,"COMPONENT_ITEMS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(component_items_AST))));
#line 8039 "AdaParser.cpp"
			currentAST.root = component_items_AST;
			if ( component_items_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				component_items_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::variant_part() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST variant_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  c = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST c_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::empty_component_items() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST empty_component_items_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 792 "ada.g"
			empty_component_items_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(COMPONENT_ITEMS,"COMPONENT_ITEMS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(empty_component_items_AST))));
#line 8118 "AdaParser.cpp"
			currentAST.root = empty_component_items_AST;
			if ( empty_component_items_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				empty_component_items_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::discriminant_direct_name() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discriminant_direct_name_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		RefAdaAST tmp224_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
			tmp224_AST = astFactory->create(LT(1));
			astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp224_AST));
		}
		match(IDENTIFIER);
...
void AdaParser::variant_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST variant_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 805 "ada.g"
			variant_s_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(VARIANTS,"VARIANTS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(variant_s_AST))));
#line 8194 "AdaParser.cpp"
			currentAST.root = variant_s_AST;
			if ( variant_s_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				variant_s_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::variant() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST variant_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  w = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST w_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::choice_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST choice_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		for (;;) {
			if ((LA(1) == PIPE)) {
				RefAdaAST tmp226_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp226_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp226_AST));
				}
				match(PIPE);
				choice();
				if (inputState->guessing==0) {
...
void AdaParser::choice() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST choice_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		if ((LA(1) == OTHERS)) {
			RefAdaAST tmp227_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp227_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp227_AST));
			}
			match(OTHERS);
...
void AdaParser::discrete_with_range() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discrete_with_range_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::mark_with_constraint() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST mark_with_constraint_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 825 "ada.g"
			mark_with_constraint_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MARK_WITH_CONSTRAINT,"MARK_WITH_CONSTRAINT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(mark_with_constraint_AST))));
#line 8439 "AdaParser.cpp"
			currentAST.root = mark_with_constraint_AST;
			if ( mark_with_constraint_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				mark_with_constraint_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::generic_formal_part_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST generic_formal_part_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 871 "ada.g"
			generic_formal_part_opt_AST =
						RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(GENERIC_FORMAL_PART,"GENERIC_FORMAL_PART")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(generic_formal_part_opt_AST))));
#line 8510 "AdaParser.cpp"
			currentAST.root = generic_formal_part_opt_AST;
			if ( generic_formal_part_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				generic_formal_part_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::generic_formal_parameter() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST generic_formal_parameter_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  t = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST t_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  w = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST w_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::discriminable_type_definition(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST discriminable_type_definition_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::subprogram_default_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST subprogram_default_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case IS:
		{
			...
			case BOX:
			{
				RefAdaAST tmp255_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp255_AST = astFactory->create(LT(1));
					astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp255_AST));
				}
				match(BOX);
				break;
			}
...
void AdaParser::formal_package_actual_part_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST formal_package_actual_part_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case LPAREN:
		{
			...
			case BOX:
			{
				RefAdaAST tmp257_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp257_AST = astFactory->create(LT(1));
					astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp257_AST));
				}
				match(BOX);
				break;
			}
...
void AdaParser::body_part() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST body_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::declarative_part() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST declarative_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 964 "ada.g"
			declarative_part_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DECLARATIVE_PART,"DECLARATIVE_PART")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(declarative_part_AST))));
#line 9138 "AdaParser.cpp"
			currentAST.root = declarative_part_AST;
			if ( declarative_part_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				declarative_part_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::block_body() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST block_body_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  b = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST b_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		b = LT(1);
		if ( inputState->guessing == 0 ) {
			b_AST = astFactory->create(b);
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(b_AST));
		}
		match(BEGIN);
		handled_stmt_s();
		if (inputState->guessing==0) {
...
void AdaParser::declarative_item() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST declarative_item_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  pkg = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST pkg_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  tsk = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST tsk_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::body_is() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST body_is_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::separate() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST separate_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::prot_op_bodies_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST prot_op_bodies_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1025 "ada.g"
			prot_op_bodies_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(PROT_OP_BODIES_OPT,"PROT_OP_BODIES_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(prot_op_bodies_opt_AST))));
#line 9597 "AdaParser.cpp"
			currentAST.root = prot_op_bodies_opt_AST;
			if ( prot_op_bodies_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				prot_op_bodies_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::block_body_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST block_body_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1016 "ada.g"
			block_body_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(BLOCK_BODY_OPT,"BLOCK_BODY_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(block_body_opt_AST))));
#line 9652 "AdaParser.cpp"
			currentAST.root = block_body_opt_AST;
			if ( block_body_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				block_body_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::handled_stmt_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST handled_stmt_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1048 "ada.g"
			handled_stmt_s_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(HANDLED_SEQUENCE_OF_STATEMENTS,"HANDLED_SEQUENCE_OF_STATEMENTS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(handled_stmt_s_AST))));
#line 9694 "AdaParser.cpp"
			currentAST.root = handled_stmt_s_AST;
			if ( handled_stmt_s_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				handled_stmt_s_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::entry_body() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST entry_body_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  e = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST e_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::subprog_decl_or_body() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST subprog_decl_or_body_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  f = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST f_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::statements() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST statements_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1054 "ada.g"
			statements_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(SEQUENCE_OF_STATEMENTS,"SEQUENCE_OF_STATEMENTS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(statements_AST))));
#line 9956 "AdaParser.cpp"
			currentAST.root = statements_AST;
			if ( statements_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				statements_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::except_handler_part_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST except_handler_part_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1340 "ada.g"
			except_handler_part_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(EXCEPT_HANDLER_PART_OPT,"EXCEPT_HANDLER_PART_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(except_handler_part_opt_AST))));
#line 10024 "AdaParser.cpp"
			currentAST.root = except_handler_part_opt_AST;
			if ( except_handler_part_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				except_handler_part_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::statement() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST statement_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1080 "ada.g"
			statement_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(STATEMENT,"STATEMENT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(statement_AST))));
#line 10230 "AdaParser.cpp"
			currentAST.root = statement_AST;
			if ( statement_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				statement_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::def_label_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST def_label_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		{
			match(LT_LT);
			RefAdaAST tmp279_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
...
#line 1084 "ada.g"
			def_label_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(LABEL_OPT,"LABEL_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(def_label_opt_AST))));
#line 10304 "AdaParser.cpp"
			currentAST.root = def_label_opt_AST;
			if ( def_label_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				def_label_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::null_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST null_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  s = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::exit_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST exit_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  s = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case WHEN:
		{
			RefAdaAST tmp282_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
...
void AdaParser::return_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST return_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  s = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::goto_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST goto_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  s = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::delay_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST delay_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  d = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST d_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::abort_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST abort_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  a = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST a_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::raise_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST raise_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  r = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST r_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::requeue_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST requeue_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  r = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST r_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		{
			match(WITH);
			RefAdaAST tmp291_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp291_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp291_AST));
			}
			match(ABORT);
			break;
		}
...
void AdaParser::accept_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST accept_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  a = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST a_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::select_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST select_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  s = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::if_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST if_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  s = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::case_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST case_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  s = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::loop_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST loop_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1126 "ada.g"
			loop_stmt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(LOOP_STATEMENT,"LOOP_STATEMENT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(loop_stmt_AST))));
#line 11068 "AdaParser.cpp"
			currentAST.root = loop_stmt_AST;
			if ( loop_stmt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				loop_stmt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::block() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST block_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1173 "ada.g"
			block_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(BLOCK_STATEMENT,"BLOCK_STATEMENT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(block_AST))));
#line 11109 "AdaParser.cpp"
			currentAST.root = block_AST;
			if ( block_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				block_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::statement_identifier() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST statement_identifier_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  n = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST n_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::id_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST id_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	RefAdaAST n_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
#line 1141 "ada.g"
	RefAdaAST endid;
...
void AdaParser::call_or_assignment() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST call_or_assignment_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1197 "ada.g"
				call_or_assignment_AST =
							RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(ASSIGNMENT_STATEMENT,"ASSIGNMENT_STATEMENT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(call_or_assignment_AST))));
#line 11250 "AdaParser.cpp"
				currentAST.root = call_or_assignment_AST;
				if ( call_or_assignment_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
					call_or_assignment_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
#line 1200 "ada.g"
				call_or_assignment_AST =
							RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(CALL_STATEMENT,"CALL_STATEMENT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(call_or_assignment_AST))));
...
void AdaParser::cond_clause() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST cond_clause_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  c = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST c_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::elsifs_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST elsifs_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1106 "ada.g"
			elsifs_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(ELSIFS_OPT,"ELSIFS_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(elsifs_opt_AST))));
#line 11367 "AdaParser.cpp"
			currentAST.root = elsifs_opt_AST;
			if ( elsifs_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				elsifs_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::else_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST else_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1110 "ada.g"
			else_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(ELSE_OPT,"ELSE_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(else_opt_AST))));
#line 11421 "AdaParser.cpp"
			currentAST.root = else_opt_AST;
			if ( else_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				else_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::condition() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST condition_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::alternative_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST alternative_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::case_statement_alternative() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST case_statement_alternative_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  s = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::iteration_scheme_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST iteration_scheme_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case WHILE:
		{
			RefAdaAST tmp319_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp319_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp319_AST));
			}
			match(WHILE);
			condition();
			if (inputState->guessing==0) {
		...
		case FOR:
		{
			RefAdaAST tmp320_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp320_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp320_AST));
			}
			match(FOR);
			RefAdaAST tmp321_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp321_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp321_AST));
			}
			match(IDENTIFIER);
			match(IN);
			reverse_opt();
...
#line 1132 "ada.g"
			iteration_scheme_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(ITERATION_SCHEME_OPT,"ITERATION_SCHEME_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(iteration_scheme_opt_AST))));
#line 11609 "AdaParser.cpp"
			currentAST.root = iteration_scheme_opt_AST;
			if ( iteration_scheme_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				iteration_scheme_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::reverse_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST reverse_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case REVERSE:
		{
			RefAdaAST tmp323_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
...
#line 1138 "ada.g"
			reverse_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(reverse_opt_AST))));
#line 11674 "AdaParser.cpp"
			currentAST.root = reverse_opt_AST;
			if ( reverse_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				reverse_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::declare_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST declare_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1177 "ada.g"
			declare_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DECLARE_OPT,"DECLARE_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(declare_opt_AST))));
#line 11728 "AdaParser.cpp"
			currentAST.root = declare_opt_AST;
			if ( declare_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				declare_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::label_name() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST label_name_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		RefAdaAST tmp325_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
			tmp325_AST = astFactory->create(LT(1));
			astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp325_AST));
		}
		match(IDENTIFIER);
...
void AdaParser::entry_body_formal_part() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST entry_body_formal_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::entry_barrier() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST entry_barrier_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::entry_index_spec_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST entry_index_spec_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1222 "ada.g"
			entry_index_spec_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(ENTRY_INDEX_SPECIFICATION,"ENTRY_INDEX_SPECIFICATION")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(entry_index_spec_opt_AST))));
#line 11880 "AdaParser.cpp"
			currentAST.root = entry_index_spec_opt_AST;
			if ( entry_index_spec_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				entry_index_spec_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::entry_call_stmt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST entry_call_stmt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1232 "ada.g"
			entry_call_stmt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(ENTRY_CALL_STATEMENT,"ENTRY_CALL_STATEMENT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(entry_call_stmt_AST))));
#line 11919 "AdaParser.cpp"
			currentAST.root = entry_call_stmt_AST;
			if ( entry_call_stmt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				entry_call_stmt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::entry_index_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST entry_index_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1251 "ada.g"
			entry_index_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(ENTRY_INDEX_OPT,"ENTRY_INDEX_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(entry_index_opt_AST))));
#line 11987 "AdaParser.cpp"
			currentAST.root = entry_index_opt_AST;
			if ( entry_index_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				entry_index_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::until_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST until_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case UNTIL:
		{
			RefAdaAST tmp334_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp334_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp334_AST));
			}
			match(UNTIL);
			break;
		}
...
#line 1261 "ada.g"
			until_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(MODIFIERS,"MODIFIERS")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(until_opt_AST))));
#line 12052 "AdaParser.cpp"
			currentAST.root = until_opt_AST;
			if ( until_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				until_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::triggering_alternative() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST triggering_alternative_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1285 "ada.g"
			triggering_alternative_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(TRIGGERING_ALTERNATIVE,"TRIGGERING_ALTERNATIVE")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(triggering_alternative_AST))));
#line 12114 "AdaParser.cpp"
			currentAST.root = triggering_alternative_AST;
			if ( triggering_alternative_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				triggering_alternative_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::abortable_part() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST abortable_part_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1291 "ada.g"
			abortable_part_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(ABORTABLE_PART,"ABORTABLE_PART")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(abortable_part_AST))));
#line 12152 "AdaParser.cpp"
			currentAST.root = abortable_part_AST;
			if ( abortable_part_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				abortable_part_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::selective_accept() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST selective_accept_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::entry_call_alternative() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST entry_call_alternative_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1297 "ada.g"
			entry_call_alternative_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(ENTRY_CALL_ALTERNATIVE,"ENTRY_CALL_ALTERNATIVE")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(entry_call_alternative_AST))));
#line 12230 "AdaParser.cpp"
			currentAST.root = entry_call_alternative_AST;
			if ( entry_call_alternative_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				entry_call_alternative_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::delay_alternative() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST delay_alternative_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1322 "ada.g"
			delay_alternative_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(DELAY_ALTERNATIVE,"DELAY_ALTERNATIVE")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(delay_alternative_AST))));
#line 12272 "AdaParser.cpp"
			currentAST.root = delay_alternative_AST;
			if ( delay_alternative_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				delay_alternative_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::stmts_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST stmts_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::guard_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST guard_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1306 "ada.g"
			guard_opt_AST = RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(GUARD_OPT,"GUARD_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(guard_opt_AST))));
#line 12409 "AdaParser.cpp"
			currentAST.root = guard_opt_AST;
			if ( guard_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				guard_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::select_alternative() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST select_alternative_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  t = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST t_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case TERMINATE:
		{
			...
			if ( inputState->guessing == 0 ) {
				t_AST = astFactory->create(t);
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(t_AST));
			}
			match(TERMINATE);
			match(SEMI);
			if ( inputState->guessing==0 ) {
...
void AdaParser::or_select_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST or_select_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1331 "ada.g"
			or_select_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(OR_SELECT_OPT,"OR_SELECT_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(or_select_opt_AST))));
#line 12525 "AdaParser.cpp"
			currentAST.root = or_select_opt_AST;
			if ( or_select_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				or_select_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::accept_alternative() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST accept_alternative_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 1316 "ada.g"
			accept_alternative_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(ACCEPT_ALTERNATIVE,"ACCEPT_ALTERNATIVE")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(accept_alternative_AST))));
#line 12567 "AdaParser.cpp"
			currentAST.root = accept_alternative_AST;
			if ( accept_alternative_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				accept_alternative_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::exception_handler() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST exception_handler_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  w = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST w_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::identifier_colon_opt() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST identifier_colon_opt_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		{
		if ((LA(1) == IDENTIFIER) && (LA(2) == COLON)) {
			RefAdaAST tmp340_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp340_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp340_AST));
			}
			match(IDENTIFIER);
			match(COLON);
		}
...
#line 1351 "ada.g"
			identifier_colon_opt_AST =
					RefAdaAST(astFactory->make((new ANTLR_USE_NAMESPACE(antlr)ASTArray(2))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(astFactory->create(IDENTIFIER_COLON_OPT,"IDENTIFIER_COLON_OPT")))->add(static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(identifier_colon_opt_AST))));
#line 12664 "AdaParser.cpp"
			currentAST.root = identifier_colon_opt_AST;
			if ( identifier_colon_opt_AST!=static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) &&
				identifier_colon_opt_AST->getFirstChild() != static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST) )
...
void AdaParser::except_choice_s() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST except_choice_s_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		for (;;) {
			if ((LA(1) == PIPE)) {
				RefAdaAST tmp342_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp342_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp342_AST));
				}
				match(PIPE);
				exception_choice();
				if (inputState->guessing==0) {
...
void AdaParser::exception_choice() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST exception_choice_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case OTHERS:
		{
			RefAdaAST tmp343_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp343_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp343_AST));
			}
			match(OTHERS);
			exception_choice_AST = static_cast<RefAdaAST>(currentAST.root);
			break;
...
void AdaParser::operator_call() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST operator_call_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  cs = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST cs_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	
	try {      // for error handling
		cs = LT(1);
		if ( inputState->guessing == 0 ) {
			cs_AST = astFactory->create(cs);
			astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(cs_AST));
		}
		match(CHAR_STRING);
...
void AdaParser::operator_call_tail(
	...
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST operator_call_tail_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::relation() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST relation_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  n = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST n_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case IN:
		{
			RefAdaAST tmp346_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp346_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp346_AST));
			}
			match(IN);
			range_or_mark();
			if (inputState->guessing==0) {
		...
		case NOT:
		{
			...
			if ( inputState->guessing == 0 ) {
				n_AST = astFactory->create(n);
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(n_AST));
			}
			match(NOT);
			match(IN);
			range_or_mark();
...
#line 12888 "AdaParser.cpp"
		...
		case EQ:
		{
			RefAdaAST tmp348_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp348_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp348_AST));
			}
			match(EQ);
			simple_expression();
			if (inputState->guessing==0) {
		...
		case NE:
		{
			RefAdaAST tmp349_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp349_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp349_AST));
			}
			match(NE);
			simple_expression();
			if (inputState->guessing==0) {
		...
		case LT_:
		{
			RefAdaAST tmp350_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
		...
		case LE:
		{
			RefAdaAST tmp351_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp351_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp351_AST));
			}
			match(LE);
			simple_expression();
			if (inputState->guessing==0) {
		...
		case GT:
		{
			RefAdaAST tmp352_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp352_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp352_AST));
			}
			match(GT);
			simple_expression();
			if (inputState->guessing==0) {
		...
		case GE:
		{
			RefAdaAST tmp353_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp353_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp353_AST));
			}
			match(GE);
			simple_expression();
			if (inputState->guessing==0) {
...
void AdaParser::range_or_mark() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST range_or_mark_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::signed_term() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST signed_term_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  m = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST m_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
#line 13094 "AdaParser.cpp"
		...
		case MINUS:
		{
			...
			if ( inputState->guessing == 0 ) {
				...
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(m_AST));
			}
			match(MINUS);
			term();
			if (inputState->guessing==0) {
...
void AdaParser::term() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST term_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		for (;;) {
			...
			case STAR:
			{
				RefAdaAST tmp354_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp354_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp354_AST));
				}
				match(STAR);
				factor();
				if (inputState->guessing==0) {
			...
			case DIV:
			{
				RefAdaAST tmp355_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp355_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp355_AST));
				}
				match(DIV);
				factor();
				if (inputState->guessing==0) {
			...
			case MOD:
			{
				RefAdaAST tmp356_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp356_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp356_AST));
				}
				match(MOD);
				factor();
				if (inputState->guessing==0) {
			...
			case REM:
			{
				RefAdaAST tmp357_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp357_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp357_AST));
				}
				match(REM);
				factor();
				if (inputState->guessing==0) {
...
void AdaParser::factor() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST factor_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case NOT:
		{
			RefAdaAST tmp358_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp358_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp358_AST));
			}
			match(NOT);
			primary();
			if (inputState->guessing==0) {
		...
		case ABS:
		{
			RefAdaAST tmp359_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp359_AST = astFactory->create(LT(1));
				astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp359_AST));
			}
			match(ABS);
			primary();
			if (inputState->guessing==0) {
		...
		case NUMERIC_LIT:
		{
			...
			case EXPON:
			{
				RefAdaAST tmp360_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp360_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp360_AST));
				}
				match(EXPON);
				primary();
				if (inputState->guessing==0) {
...
void AdaParser::primary() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST primary_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  cs = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST cs_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	...
	try {      // for error handling
		...
		case NuLL:
		{
			RefAdaAST tmp361_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp361_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp361_AST));
			}
			match(NuLL);
			break;
		}
		case NUMERIC_LIT:
		{
			RefAdaAST tmp362_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp362_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp362_AST));
			}
			match(NUMERIC_LIT);
			break;
		}
		case CHARACTER_LITERAL:
		{
			RefAdaAST tmp363_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
			if ( inputState->guessing == 0 ) {
				tmp363_AST = astFactory->create(LT(1));
				astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp363_AST));
			}
			match(CHARACTER_LITERAL);
			break;
		}
...
void AdaParser::name_or_qualified() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST name_or_qualified_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
#line 1454 "ada.g"
	RefAdaAST dummy;
#line 13524 "AdaParser.cpp"
	...
	try {      // for error handling
		RefAdaAST tmp364_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
		if ( inputState->guessing == 0 ) {
			tmp364_AST = astFactory->create(LT(1));
			astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp364_AST));
		}
		match(IDENTIFIER);
		{ // ( ... )*
		for (;;) {
			...
			case DOT:
			{
				RefAdaAST tmp365_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp365_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp365_AST));
				}
				match(DOT);
				{
				switch ( LA(1)) {
				case ALL:
				{
					RefAdaAST tmp366_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
					if ( inputState->guessing == 0 ) {
						tmp366_AST = astFactory->create(LT(1));
						astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp366_AST));
					}
					match(ALL);
					break;
				}
				case IDENTIFIER:
				{
					RefAdaAST tmp367_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
					if ( inputState->guessing == 0 ) {
						tmp367_AST = astFactory->create(LT(1));
						astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp367_AST));
					}
					match(IDENTIFIER);
					break;
				}
				case CHARACTER_LITERAL:
				{
					RefAdaAST tmp368_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
					if ( inputState->guessing == 0 ) {
						tmp368_AST = astFactory->create(LT(1));
						astFactory->addASTChild(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp368_AST));
					}
					match(CHARACTER_LITERAL);
					break;
				}
...
#line 13608 "AdaParser.cpp"
			...
			case TIC:
			{
				RefAdaAST tmp370_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
				if ( inputState->guessing == 0 ) {
					tmp370_AST = astFactory->create(LT(1));
					astFactory->makeASTRoot(currentAST, static_cast<ANTLR_USE_NAMESPACE(antlr)RefAST>(tmp370_AST));
				}
				match(TIC);
				{
				switch ( LA(1)) {
...
void AdaParser::allocator() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST allocator_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  n = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST n_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::subprogram_body() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST subprogram_body_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  f = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST f_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::package_body() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST package_body_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::task_body() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST task_body_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  t = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST t_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
...
void AdaParser::protected_body() {
	returnAST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)ASTPair currentAST;
	RefAdaAST protected_body_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
	ANTLR_USE_NAMESPACE(antlr)RefToken  p = ANTLR_USE_NAMESPACE(antlr)nullToken;
	RefAdaAST p_AST = static_cast<RefAdaAST>(ANTLR_USE_NAMESPACE(antlr)nullAST);
