...
protected:
    ...
    inline TypeBinder *typeBinder() const { return m_typeBinder; }
...
private:
    ...
    CodeModel *m_model;
    parser::token_stream_type *m_tokenStream;
    TypeBinder *m_typeBinder;
    decoder m_decoder;
    QString m_currentFile;
    ScopeModelItem m_currentScope;

    // will be generated depending on the codemodel, or inserted manually, or whatever
    access_policy::access_policy_enum m_currentAccessPolicy;
    uint m_currentModifiers;
    ParameterList m_currentParameters;
    TypeModelItem m_currentType;
    QStringList m_additionalContext;
};
