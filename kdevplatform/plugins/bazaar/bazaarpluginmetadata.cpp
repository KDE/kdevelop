...
// test_bazaar builds bazaar.cpp again but in a different directory.
// This means that the kdevbazaar.json file is no longer found.
...
K_PLUGIN_FACTORY_WITH_JSON(KDevBazaarFactory, "kdevbazaar.json", registerPlugin<BazaarPlugin>();)

#include "bazaarpluginmetadata.moc"
