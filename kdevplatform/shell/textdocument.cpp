...
QWidget *TextDocument::createViewWidget(QWidget *parent)
{
    ...
    if (!d->document)
    {
        ...
        connect(d->document.data(), &KTextEditor::Document::modifiedOnDisk,
            this, [this] (KTextEditor::Document *document, bool isModified, KTextEditor::Document::ModifiedOnDiskReason reason) {
                Q_D(TextDocument);
    ...
    view->setAutomaticInvocationEnabled(core()->languageController()->completionSettings()->automaticCompletionEnabled());
