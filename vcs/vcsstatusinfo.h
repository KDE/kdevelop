...
public:
    ...
    enum State
    {
        ...
        ItemAddedIndex    = 5    /**< Item is added to index (DVCS only). */,
        ItemModifiedIndex = 6    /**< Item's modifications are added to index (DVCS only) */,
        ItemDeletedIndex  = 7    /**< Item was deleted from the index (DVCS only) */,
