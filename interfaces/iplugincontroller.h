 ...
 * the actual IPlugin* pointer to connect signals/slots you should use
 * pluginForExtension() and then the IPlugin's extension member function to get
 ...
 * of the plugin as declared in the .desktop file under the
 * X-KDE-PluginInfo-Name property. This should be used only very seldomly in
