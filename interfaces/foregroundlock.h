 ...
 * </example>
 *
 * Also make sure to lock the foreground mutex during initialization before the event loop starts.
 */
class KDEVPLATFORMINTERFACES_EXPORT ForegroundLock
{
    public:
        ...
        /// Returns whether the current thread holds the foreground mutex
        static bool isLockedForThread();
        
        bool isLocked() const;
        
        static void startEventLoop(QApplication* app);
