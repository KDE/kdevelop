...
void ModelTest::nonDestructiveBasicTest()
{
    ...
    //Deactivate this test as it breaks any QStandardItemModel, I'm
    //not sure wether the test is wrong or the model in Qt, but 
    //I already notified Benjamin Meyer about this.
