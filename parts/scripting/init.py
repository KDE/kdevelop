...
kdevelop.addMenuItem("edit", "Python action 1", foo1_action)
kdevelop.addMenuItem("edit", "Python action 2", foo2_action)
kdevelop.addMenuItem("edit", "Python action 3", foo3_action)
