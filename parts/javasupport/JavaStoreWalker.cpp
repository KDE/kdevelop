...
#line 25 "JavaStoreWalker.cpp"
		{
		if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
			_t = ASTNULL;
		switch ( _t->getType()) {
		case PACKAGE_DEF:
		{
...
#line 94 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),PACKAGE_DEF);
		_t = _t->getFirstChild();
		id=identifier(_t);
		_t = _retTree;
		_t = __t8;
...
#line 119 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),IMPORT);
		_t = _t->getFirstChild();
...
void JavaStoreWalker::typeDefinition(RefJavaAST _t) {
	...
	RefJavaAST m = static_cast<RefJavaAST>(antlr::nullAST);
	RefJavaAST mm = static_cast<RefJavaAST>(antlr::nullAST);
...
#line 147 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		case CLASS_DEF:
		{
			...
			match(static_cast<antlr::RefAST>(_t),CLASS_DEF);
			_t = _t->getFirstChild();
			m = (_t == ASTNULL) ? static_cast<RefJavaAST>(antlr::nullAST) : _t;
			modifiers(_t);
			_t = _retTree;
			RefJavaAST tmp4_AST_in = _t;
			match(static_cast<antlr::RefAST>(_t),IDENT);
			_t = _t->getNextSibling();
...
#line 220 "JavaStoreWalker.cpp"
		...
		case INTERFACE_DEF:
		{
			...
			match(static_cast<antlr::RefAST>(_t),INTERFACE_DEF);
			_t = _t->getFirstChild();
			mm = (_t == ASTNULL) ? static_cast<RefJavaAST>(antlr::nullAST) : _t;
			modifiers(_t);
			_t = _retTree;
...
#line 478 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),EXTENDS_CLAUSE);
		_t = _t->getFirstChild();
		{ // ( ... )*
		for (;;) {
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
...
#line 522 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),IMPLEMENTS_CLAUSE);
		_t = _t->getFirstChild();
		{ // ( ... )*
		for (;;) {
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
...
#line 565 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),OBJBLOCK);
		_t = _t->getFirstChild();
		{ // ( ... )*
		for (;;) {
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
...
#line 631 "JavaStoreWalker.cpp"
			...
			case STATIC_INIT:
			{
				...
				match(static_cast<antlr::RefAST>(_t),STATIC_INIT);
				_t = _t->getFirstChild();
				slist(_t);
				_t = _retTree;
				_t = __t40;
			...
			case INSTANCE_INIT:
			{
				...
				match(static_cast<antlr::RefAST>(_t),INSTANCE_INIT);
				_t = _t->getFirstChild();
				slist(_t);
				_t = _retTree;
				_t = __t41;
...
#line 762 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),TYPE);
		_t = _t->getFirstChild();
		tp=typeSpecArray(_t);
		_t = _retTree;
		_t = __t15;
...
#line 787 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		case ARRAY_DECLARATOR:
		{
			...
			match(static_cast<antlr::RefAST>(_t),ARRAY_DECLARATOR);
			_t = _t->getFirstChild();
			tp=typeSpecArray(_t);
			_t = _retTree;
			_t = __t17;
...
#line 843 "JavaStoreWalker.cpp"
	...
	RefJavaAST b = static_cast<RefJavaAST>(antlr::nullAST);
	...
	try {      // for error handling
		...
		case LITERAL_double:
		{
			b = (_t == ASTNULL) ? static_cast<RefJavaAST>(antlr::nullAST) : _t;
			builtInType(_t);
			_t = _retTree;
...
void JavaStoreWalker::builtInType(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		case LITERAL_boolean:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_boolean);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_byte:
		...
		case LITERAL_char:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_char);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_short:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_short);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_int:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_int);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_float:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_float);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_long:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_long);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_double:
...
void JavaStoreWalker::modifier(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		case LITERAL_private:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_private);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_public:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_public);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_protected:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_protected);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_static:
		...
		case LITERAL_transient:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_transient);
			_t = _t->getNextSibling();
			break;
		}
		case FINAL:
		{
			...
			match(static_cast<antlr::RefAST>(_t),FINAL);
			_t = _t->getNextSibling();
			break;
		}
		case ABSTRACT:
		...
		case LITERAL_native:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_native);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_threadsafe:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_threadsafe);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_synchronized:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_synchronized);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_const:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_const);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_volatile:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_volatile);
			_t = _t->getNextSibling();
			break;
		}
		default:
...
#line 1088 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),METHOD_DEF);
		_t = _t->getFirstChild();
		m = (_t == ASTNULL) ? static_cast<RefJavaAST>(antlr::nullAST) : _t;
		modifiers(_t);
		_t = _retTree;
...
#line 1129 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),VARIABLE_DEF);
		_t = _t->getFirstChild();
		m = (_t == ASTNULL) ? static_cast<RefJavaAST>(antlr::nullAST) : _t;
		modifiers(_t);
		_t = _retTree;
...
#line 1172 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),CTOR_DEF);
		_t = _t->getFirstChild();
		m = (_t == ASTNULL) ? static_cast<RefJavaAST>(antlr::nullAST) : _t;
		modifiers(_t);
		_t = _retTree;
...
void JavaStoreWalker::slist(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),SLIST);
		_t = _t->getFirstChild();
		{ // ( ... )*
		for (;;) {
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
...
#line 1305 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),PARAMETERS);
		_t = _t->getFirstChild();
		{ // ( ... )*
		for (;;) {
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
...
#line 1392 "JavaStoreWalker.cpp"
		...
		case LBRACK:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LBRACK);
			_t = _t->getNextSibling();
			variableDeclarator(_t,attr);
			_t = _retTree;
			break;
...
#line 1462 "JavaStoreWalker.cpp"
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),PARAMETER_DEF);
		_t = _t->getFirstChild();
		modifiers(_t);
		_t = _retTree;
		tp=typeSpec(_t);
...
void JavaStoreWalker::expression(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),EXPR);
		_t = _t->getFirstChild();
		expr(_t);
		_t = _retTree;
		_t = __t124;
...
void JavaStoreWalker::arrayInitializer(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),ARRAY_INIT);
		_t = _t->getFirstChild();
		{ // ( ... )*
		for (;;) {
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
...
void JavaStoreWalker::throwsClause(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),LITERAL_throws);
		_t = _t->getFirstChild();
		{ // ( ... )*
		for (;;) {
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
...
void JavaStoreWalker::stat(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		case LABELED_STAT:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LABELED_STAT);
			_t = _t->getFirstChild();
		...
		case LITERAL_for:
		{
			...
			match(static_cast<antlr::RefAST>(_t),FOR_INIT);
			_t = _t->getFirstChild();
			{
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
				_t = ASTNULL;
			...
			match(static_cast<antlr::RefAST>(_t),FOR_CONDITION);
			_t = _t->getFirstChild();
			{
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
				_t = ASTNULL;
			...
			match(static_cast<antlr::RefAST>(_t),FOR_ITERATOR);
			_t = _t->getFirstChild();
			{
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
				_t = ASTNULL;
		...
		case LITERAL_do:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_do);
			_t = _t->getFirstChild();
			stat(_t);
			_t = _retTree;
			expression(_t);
		...
		case LITERAL_switch:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_switch);
			_t = _t->getFirstChild();
			expression(_t);
			_t = _retTree;
			{ // ( ... )*
		...
		case LITERAL_throw:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_throw);
			_t = _t->getFirstChild();
			expression(_t);
			_t = _retTree;
			_t = __t104;
		...
		case EMPTY_STAT:
		{
			...
			match(static_cast<antlr::RefAST>(_t),EMPTY_STAT);
			_t = _t->getNextSibling();
			break;
		}
		default:
...
void JavaStoreWalker::elist(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),ELIST);
		_t = _t->getFirstChild();
		{ // ( ... )*
		for (;;) {
			if (_t == static_cast<RefJavaAST>(antlr::nullAST) )
...
void JavaStoreWalker::caseGroup(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),CASE_GROUP);
		_t = _t->getFirstChild();
		{ // ( ... )+
		int _cnt110=0;
		for (;;) {
			...
			case LITERAL_case:
			{
				...
				match(static_cast<antlr::RefAST>(_t),LITERAL_case);
				_t = _t->getFirstChild();
				expression(_t);
				_t = _retTree;
				_t = __t109;
			...
			case LITERAL_default:
			{
				...
				match(static_cast<antlr::RefAST>(_t),LITERAL_default);
				_t = _t->getNextSibling();
				break;
			}
			default:
...
void JavaStoreWalker::tryBlock(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),LITERAL_try);
		_t = _t->getFirstChild();
		slist(_t);
		_t = _retTree;
		{ // ( ... )*
		...
		case LITERAL_finally:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_finally);
			_t = _t->getFirstChild();
			slist(_t);
			_t = _retTree;
			_t = __t116;
...
void JavaStoreWalker::handler(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),LITERAL_catch);
		_t = _t->getFirstChild();
		parameterDef(_t);
		_t = _retTree;
		slist(_t);
...
void JavaStoreWalker::expr(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		case QUESTION:
		{
			...
			match(static_cast<antlr::RefAST>(_t),QUESTION);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case PLUS_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),PLUS_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case MINUS_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),MINUS_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case STAR_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),STAR_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case DIV_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),DIV_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case MOD_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),MOD_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case SR_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),SR_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case BSR_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),BSR_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case SL_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),SL_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case BAND_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),BAND_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case BXOR_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),BXOR_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case BOR_ASSIGN:
		{
			...
			match(static_cast<antlr::RefAST>(_t),BOR_ASSIGN);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case BSR:
		{
			...
			match(static_cast<antlr::RefAST>(_t),BSR);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
		...
		case LITERAL_instanceof:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_instanceof);
			_t = _t->getFirstChild();
			expr(_t);
			_t = _retTree;
			expr(_t);
...
void JavaStoreWalker::primaryExpression(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		case DOT:
		{
			...
			case NUM_FLOAT:
			{
				...
				case LITERAL_this:
				{
					...
					match(static_cast<antlr::RefAST>(_t),LITERAL_this);
					_t = _t->getNextSibling();
					break;
				}
				case LITERAL_class:
				{
					...
					match(static_cast<antlr::RefAST>(_t),LITERAL_class);
					_t = _t->getNextSibling();
					break;
				}
				case LITERAL_new:
				{
					...
					match(static_cast<antlr::RefAST>(_t),LITERAL_new);
					_t = _t->getFirstChild();
		...
		case METHOD_CALL:
		{
			...
			match(static_cast<antlr::RefAST>(_t),METHOD_CALL);
			_t = _t->getFirstChild();
			primaryExpression(_t);
			_t = _retTree;
			elist(_t);
		...
		case LITERAL_super:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_super);
			_t = _t->getNextSibling();
			break;
		}
		case LITERAL_true:
		...
		case LITERAL_null:
		{
			...
			match(static_cast<antlr::RefAST>(_t),LITERAL_null);
			_t = _t->getNextSibling();
			break;
		}
		case TYPE:
...
void JavaStoreWalker::arrayIndex(RefJavaAST _t) {
	...
	try {      // for error handling
		...
		match(static_cast<antlr::RefAST>(_t),INDEX_OP);
		_t = _t->getFirstChild();
		primaryExpression(_t);
		_t = _retTree;
		expression(_t);
...
const antlr::BitSet JavaStoreWalker::_tokenSet_0(_tokenSet_0_data_,12);
...
// "throw" "try" 
const antlr::BitSet JavaStoreWalker::_tokenSet_1(_tokenSet_1_data_,8);
