...
JavaAddClassMethodDialog::JavaAddClassMethodDialog( QWidget *parent, const char *name )
...
void JavaAddClassMethodDialog::setWidgetValues()
{
  // Top layout
...
void JavaAddClassMethodDialog::setCallbacks()
{
...
ParsedMethod *JavaAddClassMethodDialog::asSystemObj()
{
  int lpPos;
  QString decl;
...
void JavaAddClassMethodDialog::slotToggleModifier()
{
...
void JavaAddClassMethodDialog::slotVirtualClicked()
{
  pureCb.setEnabled( virtualCb.isChecked() );
  staticCb.setEnabled( !virtualCb.isChecked() );
}

void JavaAddClassMethodDialog::OK()
{
