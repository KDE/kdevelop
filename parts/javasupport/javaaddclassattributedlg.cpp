...
JavaAddClassAttributeDialog::JavaAddClassAttributeDialog( QWidget *parent, const char *name )
...
void JavaAddClassAttributeDialog::setWidgetValues()
{
  // Top layout
...
void JavaAddClassAttributeDialog::setCallbacks()
{
...
ParsedAttribute *JavaAddClassAttributeDialog::asSystemObj()
{
...
void JavaAddClassAttributeDialog::OK()
{
...
#include "javaaddclassattributedlg.moc"
