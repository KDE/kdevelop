...
static QValueList<ParsedMethod*> getVirtualMethodListForClassAndAncestors( JavaSupportPart* part, ParsedClass* pClass )
{
...
void ImplementMethodsDialog::setPart( JavaSupportPart * part )
{
    m_part = part;
}
