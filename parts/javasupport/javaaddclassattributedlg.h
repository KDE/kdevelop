...
#ifndef JAVAADDCLASSATTRIBUTEDLG_H
#define JAVAADDCLASSATTRIBUTEDLG_H
 ...
 * @author Jonas Nordin
 */
class JavaAddClassAttributeDialog : public QDialog
{
  Q_OBJECT

public: // Constructor & Destructor

  JavaAddClassAttributeDialog( QWidget *parent=0, const char *name=0 );
