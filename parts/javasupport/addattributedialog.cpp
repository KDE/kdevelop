...
public:
    ...
    void parseTranslationUnit( RefJavaAST ast )
    {
	m_line = 0;
	m_column = 0;
	m_scope.clear();
...
AddAttributeDialog::AddAttributeDialog(JavaSupportPart* javaSupport, ParsedClass* klass,
				 QWidget* parent, const char* name, bool modal, WFlags fl)
    : AddAttributeDialogBase(parent,name, modal,fl), m_javaSupport( javaSupport ), m_klass( klass ), m_count( 0 )
{
