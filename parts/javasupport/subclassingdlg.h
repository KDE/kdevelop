...
{
public:
                        SubclassingDlg(JavaSupportPart* javaSupport, const QString &formFile,QStringList &newFileNames,
                                       QWidget* parent = 0, const char* name = 0,
                                       bool modal = FALSE, WFlags fl = 0 );
                        SubclassingDlg(JavaSupportPart* javaSupport, const QString &formFile,const QString &filename,QStringList &dummy,
                                       QWidget* parent = 0, const char* name = 0,
                                       bool modal = FALSE, WFlags fl = 0 );
                        ~SubclassingDlg();
