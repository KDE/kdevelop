...
#ifndef JAVAADDCLASSMETHODDLG_H
#define JAVAADDCLASSMETHODDLG_H
 ...
 * @author Jonas Nordin
 */
class JavaAddClassMethodDialog : public QDialog
{
  Q_OBJECT
public: // Constructor & Destructor

  JavaAddClassMethodDialog( QWidget *parent=0, const char *name=0 );
