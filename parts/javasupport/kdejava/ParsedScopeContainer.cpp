...
public:
	...
	~ParsedScopeContainerJBridge() {QtSupport::qtKeyDeleted(this);}
};
...
//JNIEXPORT  JNICALL
//Java_org_kde_koala_ParsedScopeContainer_getSortedScopeList(JNIEnv *env, jobject obj)
//{
//	return () ((ParsedScopeContainerJBridge*) QtSupport::getQt(env, obj))->getSortedScopeList();
//}
