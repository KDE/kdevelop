...
public:
	...
	~ParsedAttributeJBridge() {QtSupport::qtKeyDeleted(this);}
};
...
Java_org_kde_koala_ParsedAttribute_type(JNIEnv *env, jobject obj)
{
	QString  _qstring;
	_qstring = ((ParsedAttributeJBridge*) QtSupport::getQt(env, obj))->type();
...
Java_org_kde_koala_ParsedAttribute_isInHFile(JNIEnv *env, jobject obj)
{
	return (jboolean) ((ParsedAttributeJBridge*) QtSupport::getQt(env, obj))->isInHFile();
}
...
JNIEXPORT jboolean JNICALL
Java_org_kde_koala_ParsedAttribute_isStatic(JNIEnv *env, jobject obj)
{
	return (jboolean) ((ParsedAttributeJBridge*) QtSupport::getQt(env, obj))->isStatic();
}
...
JNIEXPORT jboolean JNICALL
Java_org_kde_koala_ParsedAttribute_isConst(JNIEnv *env, jobject obj)
{
	return (jboolean) ((ParsedAttributeJBridge*) QtSupport::getQt(env, obj))->isConst();
}
