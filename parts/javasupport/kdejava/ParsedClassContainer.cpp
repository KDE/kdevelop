...
public:
	...
	~ParsedClassContainerJBridge() {QtSupport::qtKeyDeleted(this);}
};
...
//JNIEXPORT  JNICALL
//Java_org_kde_koala_ParsedClassContainer_getSortedClassList(JNIEnv *env, jobject obj)
//{
//	return () ((ParsedClassContainerJBridge*) QtSupport::getQt(env, obj))->getSortedClassList();
//}
