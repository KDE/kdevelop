...
#line 283 "expandedada.store.g"
			m_currentAccess = PIE_PROTECTED;
#line 759 "AdaStoreWalker.cpp"
			basic_declarative_items_opt(_t);
			_t = _retTree;
#line 285 "expandedada.store.g"
			m_currentAccess = PIE_PUBLIC;
#line 764 "AdaStoreWalker.cpp"
			break;
		}
		case 3:
		{
