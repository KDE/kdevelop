	...
	try {      // for error handling
		...
		for (;;) {
			...
			if ((_tokenSet_2.member(_t->getType()))) {
				...
				if ( _cnt463>=1 ) { goto _loop463; } else {throw antlr::NoViableAltException(static_cast<antlr::RefAST>(_t));}
			}
	...
	try {      // for error handling
		...
		for (;;) {
			...
			if ((_t->getType() == IDENTIFIER)) {
				...
				if ( _cnt109>=1 ) { goto _loop109; } else {throw antlr::NoViableAltException(static_cast<antlr::RefAST>(_t));}
			}
	...
	try {      // for error handling
		...
		for (;;) {
			...
			if ((_t->getType() == IDENTIFIER || _t->getType() == CHARACTER_LITERAL)) {
				...
				if ( _cnt212>=1 ) { goto _loop212; } else {throw antlr::NoViableAltException(static_cast<antlr::RefAST>(_t));}
			}
	...
	try {      // for error handling
		...
		for (;;) {
			...
			if ((_t->getType() == DOT_DOT || _t->getType() == RANGE_ATTRIBUTE_REFERENCE || _t->getType() == SUBTYPE_INDICATION)) {
				...
				if ( _cnt237>=1 ) { goto _loop237; } else {throw antlr::NoViableAltException(static_cast<antlr::RefAST>(_t));}
			}
	...
	try {      // for error handling
		...
		for (;;) {
			...
			if ((_t->getType() == DISCRIMINANT_ASSOCIATION)) {
				...
				if ( _cnt242>=1 ) { goto _loop242; } else {throw antlr::NoViableAltException(static_cast<antlr::RefAST>(_t));}
			}
	...
	try {      // for error handling
		...
		for (;;) {
			...
			if ((_t->getType() == VARIANT)) {
				...
				if ( _cnt268>=1 ) { goto _loop268; } else {throw antlr::NoViableAltException(static_cast<antlr::RefAST>(_t));}
			}
...
void AdaStoreWalker::statements(RefAdaAST _t) {
	...
	try {      // for error handling
		...
		for (;;) {
			...
			default:
			{
				if ( _cnt337>=1 ) { goto _loop337; } else {throw antlr::NoViableAltException(static_cast<antlr::RefAST>(_t));}
			}
			}
			_cnt337++;
		}
	...
	try {      // for error handling
		...
		for (;;) {
			...
			if ((_tokenSet_4.member(_t->getType()))) {
				...
				if ( _cnt439>=1 ) { goto _loop439; } else {throw antlr::NoViableAltException(static_cast<antlr::RefAST>(_t));}
			}
	...
	try {      // for error handling
		...
		for (;;) {
			...
			if ((_t->getType() == CASE_STATEMENT_ALTERNATIVE)) {
				...
				if ( _cnt361>=1 ) { goto _loop361; } else {throw antlr::NoViableAltException(static_cast<antlr::RefAST>(_t));}
			}
