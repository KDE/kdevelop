...
//    connect( core(), SIGNAL(projectConfigWidget(KDialogBase*)), this, SLOT(projectConfigWidget(KDialogBase*)) );
    ...
    m_actionDocumentFunction = new KAction(i18n("Document Current Function"), 0, Qt::CTRL+Qt::SHIFT+Qt::Key_S, this, SLOT(slotDocumentFunction()), actionCollection(), "edit_document_function");
    ...
    m_actionPreview = new KAction(i18n("Preview Doxygen Output"), 0, Qt::CTRL+Qt::ALT+Qt::Key_P, this, SLOT(slotRunPreview()), actionCollection(), "show_preview_doxygen_output");
