...
void QEditorCodeCompletion::updateBox( bool newCoordinate )
{
  ...
  if( newCoordinate ) {
    ...
    // p += QPoint( 0, m_view->doc()->getFontMetrics( QEditorDocument::ViewFont ).height() );
...
void QEditorCodeCompletion::showArgHint ( QStringList functionList, const QString& strWrapping, const QString& strDelimiter )
{
  m_pArgHint->reset();
