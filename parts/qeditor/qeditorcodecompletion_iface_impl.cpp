...
#include "qeditorcodecompletion_iface_impl.moc"
#include <kdebug.h>
#include <iostream>
...
CodeCompletion_Impl::CodeCompletion_Impl(QEditorView *view):QObject(view),m_view(view),m_commentLabel(0)
{
...
bool CodeCompletion_Impl::eventFilter( QObject *o, QEvent *e ){
  ...
  if ( o == m_completionPopup || o == m_completionListBox || o == m_completionListBox->viewport() ) {
	...
	return FALSE;
      ...
      QApplication::sendEvent(m_view->editor(), e ); // redirect the event to the editor
