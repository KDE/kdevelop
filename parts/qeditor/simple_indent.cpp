...
static int my_indentation( const QString &s )
{
...
static int my_indentForLine( QTextParag* parag )
{
    int ind = 0;
                           ...
                           int* oldIndent, int* newIndent )
{
    ...
    int oi = my_indentation( s );
    int ind = my_indentForLine( parag );
