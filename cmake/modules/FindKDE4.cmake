...
set(LIB_KIO ${KDE4_KDEUI_LIBS} kio)

set(LIB_KPARTS ${KDE4_KIO_LIBS} kparts)

set(LIB_KUTILS ${KDE4_KPARTS_LIBS} kutils)

set(LIB_KDE3SUPPORT ${QT_QT3SUPPORT_LIBRARY} ${KDE4_KUTILS_LIBS} kde3support)
