...
set(LIB_KDECORE ${KDE4_KDECORE_LIBS} ${QT_QTGUI_LIBRARY} ${X11_X11_LIB} DCOP ${ZLIB_LIBRARY})

set(LIB_KDEUI ${KDE4_KDECORE_LIBS} kdeui )

set(LIB_KIO ${KDE4_KDEUI_LIBRARIES} kio)

set(LIB_KPARTS ${KDE4_KIO_LIBRARIES} kparts)

set(LIB_KUTILS ${KDE4_KPARTS_LIBRARIES} kutils)

set(LIB_KDE3SUPPORT ${QT_QT3SUPPORT_LIBRARY} ${KDE4_KUTILS_LIBRARIES} kde3support)
