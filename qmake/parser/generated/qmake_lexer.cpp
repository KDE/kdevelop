...
namespace QMake
{
    ...
    int Lexer::yylex( QMake::Parser::semantic_type& yylval QMake::Parser::location_type& yyloc )
    {
        mylval = yylval;
        myloc = yyloc
        return yylex();
...
int QMakelex( QMake::Parser::semantic_type& yylval QMake::Parser::location_type& yyloc, QMake::Lexer* lexer)
{
