...
void LexerTest::varAssignment_data()
{
    ...
    expectedends << 2 << 5 << 9;
    QTest::newRow("row1") << "FOO += bar" << expectedtokens << expectedbegins << expectedends;
    expectedtokens.clear();
    expectedbegins.clear();
    expectedends.clear();
    expectedtokens << QMake::Parser::Token_IDENTIFIER;
    ...
    expectedends << 6 << 9 << 13;
    QTest::newRow("row5") << "    FOO += bar" << expectedtokens << expectedbegins << expectedends;
    expectedtokens.clear();
    expectedbegins.clear();
    expectedends.clear();
    expectedtokens << QMake::Parser::Token_IDENTIFIER;
    ...
    expectedbegins << 0 << 4 << 7;
    expectedends << 2 << 5 << 9;
    QTest::newRow("row6") << "FOO += bar#ffoo" << expectedtokens << expectedbegins << expectedends;
    expectedtokens.clear();
    expectedbegins.clear();
    expectedends.clear();
    expectedtokens << QMake::Parser::Token_IDENTIFIER;
    ...
    QTest::newRow("row10") << "FOO += bar \"fsfsd   sadfsd\"" << expectedtokens << expectedbegins << expectedends;
    expectedtokens.clear();
    expectedbegins.clear();
    expectedends.clear();
    expectedtokens << QMake::Parser::Token_IDENTIFIER;
    ...
    QTest::newRow("row11") << "FOO += bar \"fsfsd  # sadfsd\"" << expectedtokens << expectedbegins << expectedends;
}
...
void LexerTest::functions_data()
{
    ...
    QTest::newRow("row2") << "foo(arg1)" << expectedtokens << expectedbegins << expectedends;
    expectedtokens.clear();
    expectedbegins.clear();
    expectedends.clear();
    expectedtokens << QMake::Parser::Token_IDENTIFIER;
    ...
    QTest::newRow("row3") << "foo(arg1,arg3)" << expectedtokens << expectedbegins << expectedends;
    expectedtokens.clear();
    expectedbegins.clear();
    expectedends.clear();
    expectedtokens << QMake::Parser::Token_IDENTIFIER;
    ...
    QTest::newRow("row4") << "foo(  arg1   arg2   )" << expectedtokens << expectedbegins << expectedends;
    expectedtokens.clear();
    expectedbegins.clear();
    expectedends.clear();
    expectedtokens << QMake::Parser::Token_IDENTIFIER;
    ...
    QTest::newRow("row5") << "foo(arg1) {" << expectedtokens << expectedbegins << expectedends;
}
...
void LexerTest::operators_data()
{
    ...
    expectedbegins << 0 << 4 << 7;
    expectedends << 2 << 5 << 9;
    QTest::newRow("row2") << "foo += bar" << expectedtokens << expectedbegins << expectedends;
    expectedtokens.clear();
    expectedbegins.clear();
    expectedends.clear();
    expectedtokens << QMake::Parser::Token_IDENTIFIER;
    ...
    expectedbegins << 0 << 4 << 7;
    expectedends << 2 << 5 << 9;
    QTest::newRow("row3") << "foo -= bar" << expectedtokens << expectedbegins << expectedends;
    expectedtokens.clear();
    expectedbegins.clear();
    expectedends.clear();
    expectedtokens << QMake::Parser::Token_IDENTIFIER;
    ...
    expectedbegins << 0 << 4 << 7;
    expectedends << 2 << 5 << 9;
    QTest::newRow("row4") << "foo ~= bar" << expectedtokens << expectedbegins << expectedends;
    expectedtokens.clear();
    expectedbegins.clear();
    expectedends.clear();
    expectedtokens << QMake::Parser::Token_IDENTIFIER;
