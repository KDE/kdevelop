...
constexpr QLatin1String QMakeConfig::CONFIG_GROUP("QMake_Builder");

// TODO: migrate to more generic & consistent key term "QMake_Executable"
constexpr QLatin1String QMakeConfig::QMAKE_EXECUTABLE("QMake_Binary");
constexpr QLatin1String QMakeConfig::BUILD_FOLDER("Build_Folder");
constexpr QLatin1String QMakeConfig::INSTALL_PREFIX("Install_Prefix");
constexpr QLatin1String QMakeConfig::EXTRA_ARGUMENTS("Extra_Arguments");
constexpr QLatin1String QMakeConfig::BUILD_TYPE("Build_Type");
constexpr QLatin1String QMakeConfig::ALL_BUILDS("All_Builds");
