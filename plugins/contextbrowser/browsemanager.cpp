...
void BrowseManager::documentAdded(IDocument* document)
{
    ...
    if (textDocument) {
        QObject::connect(textDocument, &Document::viewCreated, this,
    ...
    , m_browsingByKey(0)
{
    ...
    QObject::connect(documentController, &IDocumentController::textDocumentCreated, this,
                     &BrowseManager::documentAdded);
