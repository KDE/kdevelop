...
class GNBuilder : public QObject, public KDevelop::IProjectBuilder
{
    Q_OBJECT
...
public:
    ...
    explicit GNBuilder(QObject* parent);
    ...
    KJob* configure(KDevelop::IProject* project, const GN::BuildDir& buildDir,
                    DirectoryStatus status = ___UNDEFINED___);

    /// Evaluate a directory for the use with gn
    static DirectoryStatus evaluateBuildDirectory(const KDevelop::Path& path);
