    ...
    : LaunchConfigurationPage( parent )
{
    ...
    addDependency->setIcon( QIcon::fromTheme(QStringLiteral("list-add")) );
    removeDependency->setIcon( QIcon::fromTheme(QStringLiteral("list-remove")) );
    moveDepUp->setIcon( QIcon::fromTheme(QStringLiteral("go-up")) );
    moveDepDown->setIcon( QIcon::fromTheme(QStringLiteral("go-down")) );
    browseProject->setIcon(QIcon::fromTheme(QStringLiteral("folder-document")));
...
{
    browseProject->setEnabled( dependencyAction->itemData( idx ).toString() != QLatin1String("Nothing") );
    dependencies->setEnabled( dependencyAction->itemData( idx ).toString() != QLatin1String("Nothing") );
    targetDependency->setEnabled( dependencyAction->itemData( idx ).toString() != QLatin1String("Nothing") );
}
