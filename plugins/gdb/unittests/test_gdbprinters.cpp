...
void QtPrintersTest::testQDateTime()
{
    ...
    gdb.execute("break qdatetime.cpp:19");
    gdb.execute("run");
    QCOMPARE(printedValue(gdb, "dt"), "2010-01-20 15:31:13.000");
    QCOMPARE(printedValue(gdb, "utc"), "2024-02-01 16:28:07.000 UTC");
    QCOMPARE(printedValue(gdb, "lunchInNewYork"), "2025-01-02 12:00:00.000 UTC-5");
...
void QtPrintersTest::testQTimeZone()
{
    ...
    QCOMPARE(printedValue(gdb, "newYork"), "UTC-5");
