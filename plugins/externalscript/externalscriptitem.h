...
public:
  ...
  /// Defines what type of filter should be applied to the output of a script run.
  enum FilterMode
  {
    /// Nothing.
    NoFilter,
    /// Filter for errors generated by known compilers.
    CompilerFilter,
    /// Filter for errors generated by PHP or Python scripts.
    ScriptErrorFilter,
    /// Filter for errors generated by Static Analysis tools (CPPcheck, Krazy etc.).
