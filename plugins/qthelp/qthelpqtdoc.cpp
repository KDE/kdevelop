...
QtHelpQtDoc::QtHelpQtDoc(QObject* parent, const QString& qmake, const QString& collectionFilePath)
...
{
    QStringList candidates{QStringLiteral("qmake"), QStringLiteral("qmake-qt4"), QStringLiteral("qmake-qt5")};
    auto it = std::remove_if(candidates.begin(), candidates.end(), [](const QString& candidate) {
