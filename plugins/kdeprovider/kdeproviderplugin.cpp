...
K_PLUGIN_FACTORY(KDevKDEProvider, registerPlugin<KDEProviderPlugin>(); )
...
KDevelop::ContextMenuExtension KDEProviderPlugin::contextMenuExtension ( KDevelop::Context* context )
{
    if( actionMap )
    {
        delete actionMap;
...
QList< QAction* > KDEProviderPlugin::actionsForServices ( const KService::List& list, KService::Ptr pref )
{
...
void KDEProviderPlugin::openDefault()
{
...
void KDEProviderPlugin::open ( const QString& storageid )
{
