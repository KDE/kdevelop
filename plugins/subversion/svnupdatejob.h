...
#ifndef SVNUPDATEJOB_H
#define SVNUPDATEJOB_H
...
class SvnUpdateJob : public SvnJobBase
{
    Q_OBJECT
public:
    SvnUpdateJob( KDevSvnPlugin* parent, KDevelop::OutputJob::OutputJobVerbosity verbosity = KDevelop::OutputJob::Verbose );
