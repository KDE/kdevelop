  ...
  : QWidget( parent, name )
{
  ...
  Q3HBoxLayout *lo = new Q3HBoxLayout( this );
...
void KActionSelector::setButtonIcon( const QString &icon, MoveButton button )
{
  switch ( button )
  {
    ...
    break;
    default:
    kDebug()<<"KActionSelector::setButtonIcon: DAINBREAD!"<<endl;
  }
}
...
void KActionSelector::setButtonIconSet( const QIcon &iconset, MoveButton button )
{
  switch ( button )
  {
    ...
    break;
    default:
    kDebug()<<"KActionSelector::setButtonIconSet: DAINBREAD!"<<endl;
  }
}
...
void KActionSelector::setButtonTooltip( const QString &tip, MoveButton button )
{
  switch ( button )
  {
    ...
    break;
    default:
    kDebug()<<"KActionSelector::setButtonToolTip: DAINBREAD!"<<endl;
  }
}
