...
void QTestOutputMorpherTest::parse()
{
...
// ********* Start testing of QTest::ut::QTestCaseTest *********
// Config: Using QTest library 4.4.0, Qt 4.4.0
// PASS   : QTest::ut::QTestCaseTest::initTestCase()
// QWARN  : QTest::ut::QTestCaseTest::construct() QFile::remove: Empty or null file name
// QWARN  : QTest::ut::QTestCaseTest::construct() QFile::remove: Empty or null file name
// QWARN  : QTest::ut::QTestCaseTest::construct() QFile::remove: Empty or null file name
// PASS   : QTest::ut::QTestCaseTest::construct()
// QWARN  : QTest::ut::QTestCaseTest::addCommand() QFile::remove: Empty or null file name
// QWARN  : QTest::ut::QTestCaseTest::addCommand() QFile::remove: Empty or null file name
// QWARN  : QTest::ut::QTestCaseTest::addCommand() QFile::remove: Empty or null file name
// PASS   : QTest::ut::QTestCaseTest::addCommand()
// QWARN  : QTest::ut::QTestCaseTest::addCommands() QFile::remove: Empty or null file name
// QWARN  : QTest::ut::QTestCaseTest::addCommands() QFile::remove: Empty or null file name
// QWARN  : QTest::ut::QTestCaseTest::addCommands() QFile::remove: Empty or null file name
// PASS   : QTest::ut::QTestCaseTest::addCommands()
// PASS   : QTest::ut::QTestCaseTest::cleanupTestCase()
// Totals: 5 passed, 0 failed, 0 skipped
// ********* Finished testing of QTest::ut::QTestCaseTest *********
// nix:~/KdeDev/kdevelop/build/plugins/xtest/qtest/tests> ./qtest-ut-qtestcase -xml
// <?xml version="1.0" encoding="ISO-8859-1"?>
// <TestCase name="QTest::ut::QTestCaseTest">
// <Environment>
//     <QtVersion>4.4.0</QtVersion>
//     <QTestVersion>4.4.0</QTestVersion>
// </Environment>
...
QTEST_KDEMAIN(QTestOutputMorpherTest, NoGUI)
