...
using QxCheck::it::CheckRunnerTest;
...
// helper
void CheckRunnerTest::checkRunnerItems(QStringList runnerItems)
{
...
// helper
void CheckRunnerTest::checkRunnerItem(const QVariant& expected, int lvl0, int lvl1, int lvl2)
{
