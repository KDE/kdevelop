...
using QxCppUnit::it::CppUnitRunnerTest;
...
// command
void CppUnitRunnerTest::testmodel()
{
    CppUnitModel* model = new CppUnitModel();
...
// helper
void CppUnitRunnerTest::checkRunnerItems(QStringList runnerItems)
{
...
// helper
void CppUnitRunnerTest::checkRunnerItem(const QVariant& expected, int lvl0, int lvl1, int lvl2)
{
