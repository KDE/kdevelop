...
#ifndef QXRUNNER_RESULTSPROXYMODELTEST_H
#define QXRUNNER_RESULTSPROXYMODELTEST_H
...
private:
    QxRunner::ResultsModel* source;
    QxRunner::ResultsProxyModel* proxy;
};

#endif // QXRUNNER_RESULTSPROXYMODELTEST_H
