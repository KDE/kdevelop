...
//     pattern_combo->addItems(config->readListEntry("LastSearchItems"));
...
//     use_project_box->setChecked(config->readBoolEntry("search_project_files", true));
    ...
    // TODO PORT enable this after fully implementing GrepViewPart::searchActivated()
