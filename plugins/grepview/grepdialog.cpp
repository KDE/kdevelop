 ...
 *        if available. Otherwise nullptr (directory choice will be computed internally if needed).
 */
QString searchDescription(const QString& searchPaths, const QList<QUrl>* directoryChoice)
{
