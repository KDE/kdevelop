...
class PatchHighlighter : public QObject
{
    Q_OBJECT
public:
    PatchHighlighter( KompareDiff2::DiffModel* model, KDevelop::IDocument* doc, PatchReviewPlugin* plugin, bool updatePatchFromEdits );
...
private:
    void addLineMarker( KTextEditor::MovingRange* arg1, KompareDiff2::Difference* arg2 );
    ...
    QPair<KTextEditor::MovingRange*, KompareDiff2::Difference*> rangeForMark(const KTextEditor::Mark &mark);
...
public Q_SLOTS:
    ...
    bool isRemoval( KompareDiff2::Difference* );
    bool isInsertion( KompareDiff2::Difference* );
