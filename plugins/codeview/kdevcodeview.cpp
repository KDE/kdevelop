        ...
        : QWidget( parent )
{
    ...
    if ( !KDevelop::Core::activeLanguage() )
    {
    ...
    KDevelop::CodeProxy * model = KDevelop::Core::activeLanguage() ->codeProxy();
    if ( !model )
    {
        QLabel * label = new QLabel( this );
        label->setMargin( 20 );
    ...
    if ( KDevelop::CodeDelegate * delegate = KDevelop::Core::activeLanguage() ->codeDelegate() )
