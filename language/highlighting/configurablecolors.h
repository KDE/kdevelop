...
class CodeHighlightingColors : public ConfigurableHighlightingColors {
  public:
    CodeHighlightingColors(ColorCache* cache) : ConfigurableHighlightingColors("KDev Semantic Highlighting") {
        ...
        {
        KTextEditor::Attribute::Ptr a(new KTextEditor::Attribute);
        a->setForeground(QColor(cache->blend(0x705000))); //Dark orange
        ...
        {
        KTextEditor::Attribute::Ptr a(new KTextEditor::Attribute);
        a->setForeground(QColor(cache->blend(0x9F3C5F))); // Rose
    ...
    //       a->setForeground(QColor(0x8b0019)); // Pure red
        a->setUnderlineColor(QColor(cache->blend(0x8b0019))); // Pure red
        ...
        {
        KTextEditor::Attribute::Ptr a(new KTextEditor::Attribute);
        a->setForeground(QColor(cache->blend(0x5C5C5C))); // Gray
