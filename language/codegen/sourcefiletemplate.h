 ...
 * @li @c Language The @c X-KDevelop-Language id of a language plugin which is then asked for a custom
 *                 createClassHelper.
...
public:
    ...
    /**
     * aA optional @c X-KDevelop-Language by which a language plugin for this template can be found.
     */
