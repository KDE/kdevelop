...
class KrossKDevelopReferencedTopDUContext : public QObject, public Kross::WrapperInterface
{
	Q_OBJECT
	public:
		KrossKDevelopReferencedTopDUContext(KDevelop::ReferencedTopDUContext* obj, QObject* parent=0) : QObject(parent), wrapped(obj) {}
...
class KrossKDevelopIndexedTopDUContext : public QObject, public Kross::WrapperInterface
{
	Q_OBJECT
	public:
		KrossKDevelopIndexedTopDUContext(KDevelop::IndexedTopDUContext* obj, QObject* parent=0) : QObject(parent), wrapped(obj) {}
		void* wrappedObject() const { return wrapped; }
...
class KrossKDevelopTopDUContext : public QObject, public Kross::WrapperInterface
{
	Q_OBJECT
	public:
		KrossKDevelopTopDUContext(KDevelop::TopDUContext* obj, QObject* parent=0) : QObject(parent), wrapped(obj) {}
		void* wrappedObject() const { return wrapped; }
		...
		Q_SCRIPTABLE bool hasUses() const { return wrapped->hasUses(); }
		Q_SCRIPTABLE void setHasUses(bool x0) { wrapped->setHasUses(x0); }
...
class KrossKDevelopTopDUContextCache : public QObject, public Kross::WrapperInterface
{
	Q_OBJECT
	public:
		KrossKDevelopTopDUContextCache(KDevelop::TopDUContext::Cache* obj, QObject* parent=0) : QObject(parent), wrapped(obj) {}
		void* wrappedObject() const { return wrapped; }
