...
class KrossKDevelopIndexedIdentifier : public QObject, public Kross::WrapperInterface
{
	Q_OBJECT
	public:
		KrossKDevelopIndexedIdentifier(KDevelop::IndexedIdentifier* obj, QObject* parent=0) : QObject(parent), wrapped(obj) {}
...
class KrossKDevelopIndexedQualifiedIdentifier : public QObject, public Kross::WrapperInterface
{
	Q_OBJECT
	public:
		KrossKDevelopIndexedQualifiedIdentifier(KDevelop::IndexedQualifiedIdentifier* obj, QObject* parent=0) : QObject(parent), wrapped(obj) {}
		void* wrappedObject() const { return wrapped; }
...
class KrossKDevelopIndexedTypeIdentifier : public QObject, public Kross::WrapperInterface
{
	Q_OBJECT
	public:
		KrossKDevelopIndexedTypeIdentifier(KDevelop::IndexedTypeIdentifier* obj, QObject* parent=0) : QObject(parent), wrapped(obj) {}
		void* wrappedObject() const { return wrapped; }
...
class KrossKDevelopIdentifier : public QObject, public Kross::WrapperInterface
{
	Q_OBJECT
	public:
		KrossKDevelopIdentifier(KDevelop::Identifier* obj, QObject* parent=0) : QObject(parent), wrapped(obj) {}
		void* wrappedObject() const { return wrapped; }
...
class KrossKDevelopQualifiedIdentifier : public QObject, public Kross::WrapperInterface
{
	Q_OBJECT
	public:
		KrossKDevelopQualifiedIdentifier(KDevelop::QualifiedIdentifier* obj, QObject* parent=0) : QObject(parent), wrapped(obj) {}
		void* wrappedObject() const { return wrapped; }
...
QVariant _kDevelopQualifiedIdentifierHandler(void* type)
{
	...
	if(dynamic_cast<KDevelop::TypeIdentifier*>(t)) return Handlers::_kDevelopQualifiedIdentifierHandler((void*) type);
