...
bool iuicontroller_registerHandler(const QByteArray& name, Kross::MetaTypeHandler::FunctionPtr* handler)
...
bool b_kDevelopIUiController1=iuicontroller_registerHandler("IUiController*", _kDevelopIUiControllerHandler);
bool b_kDevelopIUiController=iuicontroller_registerHandler("KDevelop::IUiController*", _kDevelopIUiControllerHandler);
...
bool b_kDevelopIToolViewFactory1=iuicontroller_registerHandler("IToolViewFactory*", _kDevelopIToolViewFactoryHandler);
bool b_kDevelopIToolViewFactory=iuicontroller_registerHandler("KDevelop::IToolViewFactory*", _kDevelopIToolViewFactoryHandler);
