...
/**
Makes a QListViewItem-based item available with the same functionality
as FancyKListViewItem under the name FancyQListViewItem,
see fancylistviewitem.h to see the definition
*/
