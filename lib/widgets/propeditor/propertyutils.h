...
PropPtr createProperty(int type, QString name, QString description="",
    QVariant value=QVariant(), bool save=true);
PropPtr createProperty(QString name, QMap<QString, QString> v_correspList,
