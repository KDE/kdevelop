...
class PSpinBox: public PropertyWidget{
    Q_OBJECT
public:
    PSpinBox(const QString &propertyName, QWidget *parent = 0, const char *name = 0);
    PSpinBox(const QString &propertyName, int minValue, int maxValue, int step = 1, QWidget *parent = 0, const char *name = 0);
