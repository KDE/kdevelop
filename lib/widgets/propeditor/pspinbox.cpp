...
PSpinBox::PSpinBox(const QString &propertyName, QWidget *parent, const char *name)
...
PSpinBox::PSpinBox(const QString &propertyName, int minValue, int maxValue, int step, QWidget *parent, const char *name)
    :PropertyWidget(propertyName, parent, name)
{
    QHBoxLayout *l = new QHBoxLayout(this, 0, 0);
