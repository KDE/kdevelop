...
#ifndef VERITAS_RUNNERVIEWCONTROLLERTEST_H
#define VERITAS_RUNNERVIEWCONTROLLERTEST_H
...
private:
    QTreeView* view;
    Veritas::RunnerModel* model;
    Veritas::RunnerProxyModel* proxy;
    Veritas::RunnerViewController* viewController;
};
