...
void ResultsModelTest::appendResults()
{
    ...
    KOMPARE(Veritas::RunSuccess, model->result(0));
    KOMPARE(Veritas::RunFatal, model->result(1));
...
void ResultsModelTest::mapIndices()
{
    ...
    KOMPARE(runIndex0, model->mapToTestIndex(resultIndex0));
    KOMPARE(resultIndex0, model->mapFromTestIndex(runIndex0));

    KOMPARE(resultIndex0, model->mapFromTestIndex(model->mapToTestIndex(resultIndex0)));
    KOMPARE(runIndex0, model->mapToTestIndex(model->mapFromTestIndex(runIndex0)));
}
...
void ResultsModelTest::errorHandling()
{
    ...
    KOMPARE(Veritas::NoResult, model->result(-1));
    KOMPARE(QModelIndex(), model->mapToTestIndex(QModelIndex()));
    KOMPARE(QModelIndex(), model->mapFromTestIndex(QModelIndex()));
}
