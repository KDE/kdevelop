...
JavaAddClassAttributeDlg::JavaAddClassAttributeDlg( QWidget *parent, const char *name )
...
void JavaAddClassAttributeDlg::setWidgetValues()
{
  // Top layout
...
void JavaAddClassAttributeDlg::setCallbacks()
{
...
ParsedAttribute *JavaAddClassAttributeDlg::asSystemObj()
{
...
void JavaAddClassAttributeDlg::OK()
{
