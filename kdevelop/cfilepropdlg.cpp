...
CFilePropDlg::CFilePropDlg(QWidget *parent, const char *name,CProject* prj ) : QDialog(parent,name,true) {
  ...
  distribution_group->setGeometry( 260, 140, 330, 60 );
  ...
  type_group->setGeometry( 470, 20, 120, 110 );
  ...
  installion_group->setGeometry( 260, 210, 330, 130 );
  ...
  file_group->setGeometry( 260, 20, 200, 110 );
  ...
  install_loc_edit->setGeometry( 270, 290, 310, 30 );
  ...
  install_loc_label->setGeometry( 270, 260, 100, 30 );
  ...
  size_label->setGeometry( 270, 80, 100, 30 );
  ...
  name_label->setGeometry( 270, 50, 70, 30 );
  ...
  incdist_check->setGeometry( 270, 160, 150, 30 );
  ...
  install_check->setGeometry( 270, 230, 100, 30 );
  ...
  ok_button->setGeometry( 170, 360, 100, 30 );
  ...
  cancel_button->setGeometry( 320, 360, 100, 30 );
  ...
  name_e_label->setGeometry( 340, 50, 100, 30 );
  ...
  size_e_label->setGeometry( 340, 80, 100, 30 );
