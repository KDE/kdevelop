...
public:
    ...
    // aditional component dependant setups
...
protected:
  ...
  KDevComponentManager* componentManager();
  void registerManager(KDevComponentManager* kdcm);
...
private slots:
   ...
   */
  virtual void slotStopButtonClicked();
