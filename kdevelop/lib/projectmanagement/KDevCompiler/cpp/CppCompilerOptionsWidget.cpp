/***************************************************************************
                          CppCompilerOptionsWidget.cpp  -  description
                             -------------------
...
CppCompilerOptionsWidget::CppCompilerOptionsWidget(QWidget *parent, const char *name, QWidget* pdlg)
	 : CppCompilerOptionsWidgetBase(parent,name){
...
CppCompilerOptionsWidget::~CppCompilerOptionsWidget(){
}

void CppCompilerOptionsWidget::slotFlagsToolButtonClicked(){
 	CppOptionsDlg *dlg = new CppOptionsDlg(this, "Cpp Project Options Dialog");
...
void CppCompilerOptionsWidget::slotWidgetStarted(KDevCompiler *kdc){
	if (kdc->id() == KDevCompiler::Cpp){
  	compilerFlagsPreview->setText(*(kdc->flags()));
	}
}

// writess the compiler flags
void CppCompilerOptionsWidget::slotButtonApplyClicked(KDevCompiler *kdc){
	if (kdc->id() == KDevCompiler::Cpp){
		compilerFlagsPreview->setText(compilerFlagsPreview->text() + " " + cppCompilerFlags->text());
		cppCompilerFlags->setText("");
  	kdc->setFlags(compilerFlagsPreview->text());
  }
}

void CppCompilerOptionsWidget::slotClearAllClicked(){
  compilerFlagsPreview->setText("");
}

GeneralTabCpp::GeneralTabCpp(QWidget *parent, const char *name)
...
GeneralTabCpp::~GeneralTabCpp()
{
    delete controller;
}


void GeneralTabCpp::readFlags(QStringList *list)
{
    controller->readFlags(list);
}


void GeneralTabCpp::writeFlags(QStringList *list)
{
    controller->writeFlags(list);
}


CodeGenTabCpp::CodeGenTabCpp(QWidget *parent, const char *name)
    : QWidget(parent, name)
{
    QBoxLayout *layout = new QVBoxLayout(this, KDialog::marginHint(), KDialog::spacingHint());
    layout->setAutoAdd(true);
...
CodeGenTabCpp::~CodeGenTabCpp()
{
}


void CodeGenTabCpp::readFlags(QStringList *list)
{
    genBox->readFlags(list);
}


void CodeGenTabCpp::writeFlags(QStringList *list)
{
    genBox->writeFlags(list);
}


OptimizationTabCpp::OptimizationTabCpp(QWidget *parent, const char *name)
    : QWidget(parent, name)
{
    QBoxLayout *layout = new QVBoxLayout(this, KDialog::marginHint(), KDialog::spacingHint());
    layout->setAutoAdd(true);
...
OptimizationTabCpp::~OptimizationTabCpp()
{}


void OptimizationTabCpp::readFlags(QStringList *list)
{
...
void OptimizationTabCpp::writeFlags(QStringList *list)
{
...
Warnings1TabCpp::Warnings1TabCpp(QWidget *parent, const char *name)
    : QWidget(parent, name), controller(new FlagCheckBoxController)
{
    QBoxLayout *layout = new QVBoxLayout(this, KDialog::marginHint(), KDialog::spacingHint());
    layout->setAutoAdd(true);
...
Warnings1TabCpp::~Warnings1TabCpp()
{
    delete controller;
}


void Warnings1TabCpp::readFlags(QStringList *list)
{
    controller->readFlags(list);
...
void Warnings1TabCpp::writeFlags(QStringList *list)
{
    controller->writeFlags(list);
    wallBox->readFlags(list);
}
...
Warnings2TabCpp::Warnings2TabCpp(QWidget *parent, const char *name)
    : QWidget(parent, name)
{
    QBoxLayout *layout = new QVBoxLayout(this, KDialog::marginHint(), KDialog::spacingHint());
    layout->setAutoAdd(true);
...
Warnings2TabCpp::~Warnings2TabCpp()
{}


void Warnings2TabCpp::readFlags(QStringList *list)
{
    wrestBox->readFlags(list);
}


void Warnings2TabCpp::writeFlags(QStringList *list)
{
    wrestBox->writeFlags(list);
}


CppOptionsDlg::CppOptionsDlg(QWidget *parent, const char *name)
    : KDialogBase(Tabbed, i18n("GNU C Compiler Options"), Ok|Cancel, Ok,parent, name, true)
{
    QVBox *vbox;

    vbox = addVBoxPage(i18n("General"));
    general = new GeneralTabCpp(vbox, "general tab");

    vbox = addVBoxPage(i18n("Code Generation"));
    codegen = new CodeGenTabCpp(vbox, "codegen tab");

    vbox = addVBoxPage(i18n("Optimization"));
    optimization = new OptimizationTabCpp(vbox, "optimization tab");

    vbox = addVBoxPage(i18n("Warnings I"));
    warnings1 = new Warnings1TabCpp(vbox, "warnings1 tab");

    vbox = addVBoxPage(i18n("Warnings II"));
    warnings2 = new Warnings2TabCpp(vbox, "warnings2 tab");
}


CppOptionsDlg::~CppOptionsDlg()
{
}

QString CppOptionsDlg::flags() const
{
...
QString CppOptionsDlg::setFlags(const QString &flags)
{
...
#include "CppCompilerOptionsWidget.moc"
