...
KDevArgHint::KDevArgHint ( QWidget *parent, Kate::View* edit )
...
void KDevArgHint::cursorPositionChanged ( int nLine, int nCol )
{
    ...
    Kate::Document* pDoc = dynamic_cast<Kate::Document*>(m_edit->document());
    QString strCurLine = pDoc	->textLine( nLine );
