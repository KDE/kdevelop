...
void CKDevInstall::slotFinished()
{
  ...
  if (m_pInstallState->highlightStyle == 0) {  // new KDevelop-2.0 style
    ...
    m_config->writeEntry("Char","0,FFDE1907,FFFF1E09,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("Comment","0,FF067817,FF1FD718,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("Data Type","0,FFAD466A,FFE65D8D,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("Decimal","1,FF000000,FFFFFFFF,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("Float","1,FF000000,FFFFFFFF,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("Hex","1,FF000000,FFFFFFFF,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("Keyword","0,FF0E23AD,FF1534FF,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("Mimetypes","text/x-c-src");
    m_config->writeEntry("Normal Text","1,FF000000,FFFFFFFF,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("Octal","1,FF000000,FFFFFFFF,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("Prep. Lib","0,FF808000,FF00FFFF,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("Preprocessor","0,FF800080,FFFF00FF,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("String","0,FFDE1907,FFFF1E09,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    m_config->writeEntry("String Char","0,FFDE1907,FFFF1E09,0,0,1,adobe-courier,12,ÃˆÃ±f@");
    ...
    m_config->writeEntry("Comment","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("String","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Normal Text","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Variable","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Operator","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Keyword","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("String Char","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    ...
    m_config->writeEntry("Data Type","0,AD466A,AD466A,0,0,1,courier,12,Èñf@");
    m_config->writeEntry("Decimal","1,0,FFFFFF,0,0,1,courier,12,Èñf@");
    m_config->writeEntry("Mimetypes","text/x-c++-src;text/x-c++-hdr;text/x-c-hdr");
    m_config->writeEntry("Hex","1,0,FFFFFF,0,0,1,courier,12,Èñf@");
    m_config->writeEntry("Preprocessor","0,800080,800080,0,0,1,courier,12,Èñf@");
    m_config->writeEntry("Wildcards","*.cpp;*.cc;*.cxx;*.CPP;*.CC;*.CXX;*.h;*.hxx;*.H;*.HXX;*.ecpp");
    m_config->writeEntry("Comment","0,E0,D7,0,0,1,courier,12,Èñf@");
    m_config->writeEntry("String","0,8000,8000,0,0,1,courier,12,Èñf@");
    m_config->writeEntry("Normal Text","1,0,FFFFFF,0,0,1,courier,12,Èñf@");
    m_config->writeEntry("Float","1,0,FFFFFF,0,0,1,courier,12,Èñf@");
    m_config->writeEntry("Keyword","0,A7AD,A7AD,0,0,1,courier,12,Èñf@");
    m_config->writeEntry("String Char","0,8000,8000,0,0,1,courier,12,Èñf@");

    m_config->setGroup("Ada Highlight");
    m_config->writeEntry("Base-N","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Char","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Decimal","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    ...
    m_config->writeEntry("Prep. Lib","0,8080,FFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Octal","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Char","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Data Type","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Decimal","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Mimetypes","text/x-java-src");
    m_config->writeEntry("Hex","1,0,FFFFFF,0,0,1,courier,12,èñf@");
    m_config->writeEntry("Preprocessor","1,0,FFFFFF,0,0,1,courier,12,èñf@");
