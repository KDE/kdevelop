...
CConfigPrintDlg::CConfigPrintDlg(QWidget* parent,const char* name) : QTabDialog(parent, name, true){
  init();
}
...
void CConfigPrintDlg::init() {
  QWidget *tab1 = new QWidget(this,"header");
  initTab1(tab1);
  addTab (tab1,"Header (header1)");

  QWidget *tab2 = new QWidget(this,"layout");
  initTab2(tab2);
  addTab (tab2,"Layout");
  QWidget *tab3 = new QWidget(this,"date & time");
  initTab3(tab3);
  addTab (tab3,"Date & Time (header2)");
...
void CConfigPrintDlg::initTab1(QWidget*parent) {
	...
	headerButton->setGeometry( 40, 10, 100, 30 );
...
void CConfigPrintDlg::initTab2(QWidget*parent) {
	...
	qtarch_Label_3->setText( "change fontsize" );
	...
	fontForBody = new QComboBox( TRUE, parent, "fontForBody" );
	fontForBody->setGeometry( 430, 380, 140, 30 );
	fontForBody->setMinimumSize( 0, 0 );
	fontForBody->setMaximumSize( 32767, 32767 );
	fontForBody->setFocusPolicy( QWidget::StrongFocus );
	fontForBody->setBackgroundMode( QWidget::PaletteBackground );
	fontForBody->setFontPropagation( QWidget::NoChildren );
	fontForBody->setPalettePropagation( QWidget::NoChildren );
	fontForBody->setInsertionPolicy( QComboBox::AtBottom );
	fontForBody->setSizeLimit( 30 );
	fontForBody->setAutoResize( FALSE );
	fontForBody->insertItem( "Times100" );

	fontForHeader = new QComboBox( TRUE, parent, "fontForHeader" );
	fontForHeader->setGeometry( 430, 340, 140, 30 );
	fontForHeader->setMinimumSize( 0, 0 );
	fontForHeader->setMaximumSize( 32767, 32767 );
	fontForHeader->setFocusPolicy( QWidget::StrongFocus );
	fontForHeader->setBackgroundMode( QWidget::PaletteBackground );
	fontForHeader->setFontPropagation( QWidget::NoChildren );
	fontForHeader->setPalettePropagation( QWidget::NoChildren );
	fontForHeader->setInsertionPolicy( QComboBox::AtBottom );
	fontForHeader->setSizeLimit( 30 );
	fontForHeader->setAutoResize( FALSE );
	fontForHeader->insertItem( "Times100" );
	...
	changeFontsize = new QSpinBox( parent, "changeFontsize" );
	changeFontsize->setGeometry( 430, 300, 140, 30 );
	changeFontsize->setMinimumSize( 0, 0 );
	changeFontsize->setMaximumSize( 32767, 32767 );
	changeFontsize->setFocusPolicy( QWidget::StrongFocus );
	changeFontsize->setBackgroundMode( QWidget::PaletteBackground );
	changeFontsize->setFontPropagation( QWidget::NoChildren );
	changeFontsize->setPalettePropagation( QWidget::NoChildren );
	changeFontsize->setFrameStyle( 50 );
	changeFontsize->setLineWidth( 2 );
	changeFontsize->setRange( 0, 200 );
	changeFontsize->setSteps( 1, 0 );
	changeFontsize->setPrefix( "" );
	changeFontsize->setSuffix( "" );
	changeFontsize->setSpecialValueText( "" );
	changeFontsize->setWrapping( FALSE );
...
void CConfigPrintDlg::initTab3(QWidget*parent) {
...
void CConfigPrintDlg::initTab4(QWidget*parent) {
	...
	qtarch_Label_73->setGeometry( 30, 260, 100, 30 );
	...
	underlayFontList = new QComboBox( TRUE, parent, "underlayFontList" );
	underlayFontList->setGeometry( 140, 260, 220, 30 );
	underlayFontList->setMinimumSize( 0, 0 );
	underlayFontList->setMaximumSize( 32767, 32767 );
	underlayFontList->setFocusPolicy( QWidget::StrongFocus );
	underlayFontList->setBackgroundMode( QWidget::PaletteBackground );
	underlayFontList->setFontPropagation( QWidget::AllChildren );
	underlayFontList->setPalettePropagation( QWidget::AllChildren );
	underlayFontList->setInsertionPolicy( QComboBox::AtBottom );
	underlayFontList->setSizeLimit( 30 );
	underlayFontList->setAutoResize( FALSE );
	underlayFontList->insertItem( "Times" );

	underlayFontsize = new QSpinBox( parent, "underlayFontsize" );
	underlayFontsize->setGeometry( 140, 300, 80, 30 );
	underlayFontsize->setMinimumSize( 0, 0 );
	underlayFontsize->setMaximumSize( 32767, 32767 );
	underlayFontsize->setFocusPolicy( QWidget::StrongFocus );
	underlayFontsize->setBackgroundMode( QWidget::PaletteBackground );
	underlayFontsize->setFontPropagation( QWidget::NoChildren );
	underlayFontsize->setPalettePropagation( QWidget::NoChildren );
	underlayFontsize->setFrameStyle( 50 );
	underlayFontsize->setLineWidth( 2 );
	underlayFontsize->setRange( 0, 400 );
	underlayFontsize->setSteps( 1, 0 );
	underlayFontsize->setPrefix( "" );
	underlayFontsize->setSuffix( "" );
	underlayFontsize->setSpecialValueText( "" );
	underlayFontsize->setWrapping( FALSE );
	...
	qtarch_Label_74->setGeometry( 30, 380, 100, 30 );
	...
	underlayGray->setRange( 0, 1 );
	underlayGray->setSteps( 0, 0 );
	underlayGray->setPrefix( "" );
	underlayGray->setSuffix( "" );
	underlayGray->setSpecialValueText( "" );
	underlayGray->setWrapping( TRUE );
	...
	QLabel* qtarch_Label_76;
	qtarch_Label_76 = new QLabel( parent, "Label_76" );
	qtarch_Label_76->setGeometry( 30, 300, 100, 30 );
	qtarch_Label_76->setMinimumSize( 0, 0 );
	qtarch_Label_76->setMaximumSize( 32767, 32767 );
	qtarch_Label_76->setFocusPolicy( QWidget::NoFocus );
	qtarch_Label_76->setBackgroundMode( QWidget::PaletteBackground );
	qtarch_Label_76->setFontPropagation( QWidget::NoChildren );
	qtarch_Label_76->setPalettePropagation( QWidget::NoChildren );
	qtarch_Label_76->setText( "fontsize" );
	qtarch_Label_76->setAlignment( 289 );
	qtarch_Label_76->setMargin( -1 );
