/***************************************************************************
                          kdeobjcsdiappwizardplugin.h  -  description
                             -------------------
...
#ifndef KDEOBJCSDIAPPWIZARDPLUGIN_H
#define KDEOBJCSDIAPPWIZARDPLUGIN_H
...
class KDEObjcSDIAppWizardPlugin : public AppWizard  {
Q_OBJECT
  public: 
 KDEObjcSDIAppWizardPlugin(QObject* parent=0,const char* name=0);
 ~KDEObjcSDIAppWizardPlugin();
