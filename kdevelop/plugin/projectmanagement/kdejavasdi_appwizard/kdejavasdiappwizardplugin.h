/***************************************************************************
                          kdejavasdiappwizardplugin.h  -  description
                             -------------------
...
#ifndef KDEJAVASDIAPPWIZARDPLUGIN_H
#define KDEJAVASDIAPPWIZARDPLUGIN_H
...
class KDEJavaSDIAppWizardPlugin : public AppWizard  {
Q_OBJECT
  public:
 KDEJavaSDIAppWizardPlugin(QObject* parent=0,const char* name=0);
 ~KDEJavaSDIAppWizardPlugin();
