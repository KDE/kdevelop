...
#ifndef _CCTVIEWDEFINITONCMD_H_INCLUDED
#define _CCTVIEWDEFINITONCMD_H_INCLUDED

#include "ccommand.h"

class CClassView;

class CCTViewDefinitionCmd : public CCommand
{
public: // Constructor & destructor
  CCTViewDefinitionCmd();
  virtual ~CCTViewDefinitionCmd();
