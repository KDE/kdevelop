...
CBugReportDlg::CBugReportDlg(QWidget *parent, const char *name,QString author="",QString author_email="", QString bug_email="") : QTabDialog(parent,name,TRUE) {
  ...
  KQuickHelp::add(w, i18n("Fill in all information,\nwe need to help you."));
	...
	email_edit->setText(author_email);
