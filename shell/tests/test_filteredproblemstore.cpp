...
bool TestFilteredProblemStore::checkCounts(int error, int warning, int hint)
{
    ...
    MYVERIFY(errorNode != nullptr);
    MYVERIFY(warningNode != nullptr);
    MYVERIFY(hintNode != nullptr);
